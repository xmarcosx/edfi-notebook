...
class TeacherCandidatesApi(object):
    ...
    def get_teacher_candidates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('english_language_exam_descriptor' in params and
        ...
        if ('previous_career_descriptor' in params and
        ...
        if ('displacement_status' in params and
    ...
    def post_teacher_candidate_with_http_info(self, teacher_candidate, **kwargs):  # noqa: E501
        ...
        if ('teacher_candidate' not in params or
                params['teacher_candidate'] is None):
