...
class GradingPeriodsApi(object):
    ...
    def get_grading_periods_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'grading_period_descriptor', 'period_sequence', 'school_id', 'school_year', 'begin_date', 'end_date', 'id', 'total_instructional_days']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_grading_period_with_http_info(self, grading_period, **kwargs):  # noqa: E501
        ...
        if ('grading_period' not in params or
