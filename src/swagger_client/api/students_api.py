...
class StudentsApi(object):
    ...
    def get_students_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('citizenship_status_descriptor' in params and
        ...
        if ('birth_country_descriptor' in params and
        ...
        if ('birth_sex_descriptor' in params and
        ...
        if ('birth_state_abbreviation_descriptor' in params and
        ...
        if ('birth_international_province' in params and
    ...
    def post_student_with_http_info(self, student, **kwargs):  # noqa: E501
        ...
        if ('student' not in params or
                params['student'] is None):
