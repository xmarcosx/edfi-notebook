...
class ClassPeriodsApi(object):
    ...
    def get_class_periods_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'class_period_name', 'school_id', 'id', 'official_attendance_period']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('class_period_name' in params and
    ...
    def post_class_period_with_http_info(self, class_period, **kwargs):  # noqa: E501
        ...
        if ('class_period' not in params or
                params['class_period'] is None):
