...
class StudentSchoolAssociationsApi(object):
    ...
    def get_student_school_associations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'entry_date', 'school_id', 'student_unique_id', 'calendar_code', 'school_year', 'education_organization_id', 'graduation_plan_type_descriptor', 'graduation_school_year', 'class_of_school_year', 'entry_grade_level_reason_descriptor', 'entry_type_descriptor', 'exit_withdraw_type_descriptor', 'entry_grade_level_descriptor', 'residency_status_descriptor', 'employed_while_enrolled', 'exit_withdraw_date', 'full_time_equivalency', 'id', 'primary_school', 'repeat_grade_indicator', 'school_choice_transfer', 'term_completion_indicator']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('entry_grade_level_reason_descriptor' in params and
        ...
        if ('entry_grade_level_descriptor' in params and
        ...
        if ('residency_status_descriptor' in params and
    ...
    def post_student_school_association_with_http_info(self, student_school_association, **kwargs):  # noqa: E501
        ...
        if ('student_school_association' not in params or
                params['student_school_association'] is None):
