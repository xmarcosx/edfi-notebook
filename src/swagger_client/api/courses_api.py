...
class CoursesApi(object):
    ...
    def get_courses_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('career_pathway_descriptor' in params and
        ...
        if ('course_defined_by_descriptor' in params and
        ...
        if ('course_gpa_applicability_descriptor' in params and
        ...
        if ('minimum_available_credit_type_descriptor' in params and
        ...
        if ('maximum_available_credit_type_descriptor' in params and
        ...
        if ('course_description' in params and
    ...
    def post_course_with_http_info(self, course, **kwargs):  # noqa: E501
        ...
        if ('course' not in params or
                params['course'] is None):
