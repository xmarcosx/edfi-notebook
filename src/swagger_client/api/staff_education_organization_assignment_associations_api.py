...
class StaffEducationOrganizationAssignmentAssociationsApi(object):
    ...
    def get_staff_education_organization_assignment_associations(self, **kwargs):  # noqa: E501
        ...
        :param date begin_date: Month, day, and year of the start or effective date of a staff member's employment, contract, or relationship with the LEA.
        ...
        :param date end_date: Month, day, and year of the end or termination date of a staff member's employment, contract, or relationship with the LEA.
        :param str id: 
    ...
    def get_staff_education_organization_assignment_associations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'staff_classification_descriptor', 'begin_date', 'education_organization_id', 'staff_unique_id', 'credential_identifier', 'state_of_issue_state_abbreviation_descriptor', 'employment_education_organization_id', 'employment_status_descriptor', 'employment_hire_date', 'end_date', 'id', 'order_of_assignment', 'position_title']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_staff_education_organization_assignment_association_with_http_info(self, staff_education_organization_assignment_association, **kwargs):  # noqa: E501
        ...
        if ('staff_education_organization_assignment_association' not in params or
                params['staff_education_organization_assignment_association'] is None):
