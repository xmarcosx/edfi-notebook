...
class AssessmentItemsApi(object):
    ...
    def get_assessment_items_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'identification_code', 'assessment_identifier', 'namespace', 'assessment_item_category_descriptor', 'assessment_item_uri', 'correct_response', 'expected_time_assessed', 'id', 'item_text', 'max_raw_score', 'nomenclature']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('assessment_item_category_descriptor' in params and
        ...
        if ('assessment_item_uri' in params and
        ...
        if ('correct_response' in params and
        ...
        if ('expected_time_assessed' in params and
    ...
    def post_assessment_item_with_http_info(self, assessment_item, **kwargs):  # noqa: E501
        ...
        if ('assessment_item' not in params or
                params['assessment_item'] is None):
