...
class PostSecondaryInstitutionsApi(object):
    ...
    def get_post_secondary_institutions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'post_secondary_institution_id', 'administrative_funding_control_descriptor', 'post_secondary_institution_level_descriptor']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('post_secondary_institution_level_descriptor' in params and
    ...
    def post_post_secondary_institution_with_http_info(self, post_secondary_institution, **kwargs):  # noqa: E501
        ...
        if ('post_secondary_institution' not in params or
                params['post_secondary_institution'] is None):
