...
class StudentAssessmentsApi(object):
    ...
    def get_student_assessments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('student_assessment_identifier' in params and
        ...
        if ('administration_environment_descriptor' in params and
        ...
        if ('event_circumstance_descriptor' in params and
        ...
        if ('when_assessed_grade_level_descriptor' in params and
        ...
        if ('administration_language_descriptor' in params and
        ...
        if ('platform_type_descriptor' in params and
        ...
        if ('reason_not_tested_descriptor' in params and
        ...
        if ('retest_indicator_descriptor' in params and
        ...
        if ('serial_number' in params and
    ...
    def post_student_assessment_with_http_info(self, student_assessment, **kwargs):  # noqa: E501
        ...
        if ('student_assessment' not in params or
                params['student_assessment'] is None):
