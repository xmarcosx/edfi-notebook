...
class StaffSchoolAssociationsApi(object):
    ...
    def get_staff_school_associations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'program_assignment_descriptor', 'school_id', 'staff_unique_id', 'calendar_code', 'school_year', 'id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_staff_school_association_with_http_info(self, staff_school_association, **kwargs):  # noqa: E501
        ...
        if ('staff_school_association' not in params or
                params['staff_school_association'] is None):
