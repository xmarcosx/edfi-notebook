...
class LocalEducationAgenciesApi(object):
    ...
    def get_local_education_agencies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'local_education_agency_id', 'education_service_center_id', 'parent_local_education_agency_id', 'state_education_agency_id', 'charter_status_descriptor', 'local_education_agency_category_descriptor']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('local_education_agency_category_descriptor' in params and
    ...
    def post_local_education_agency_with_http_info(self, local_education_agency, **kwargs):  # noqa: E501
        ...
        if ('local_education_agency' not in params or
                params['local_education_agency'] is None):
