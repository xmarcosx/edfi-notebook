...
class LearningStandardEquivalenceAssociationsApi(object):
    ...
    def get_learning_standard_equivalence_associations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('source_learning_standard_id' in params and
        ...
        if ('target_learning_standard_id' in params and
        ...
        if ('learning_standard_equivalence_strength_descriptor' in params and
        ...
        if ('learning_standard_equivalence_strength_description' in params and
    ...
    def post_learning_standard_equivalence_association_with_http_info(self, learning_standard_equivalence_association, **kwargs):  # noqa: E501
        ...
        if ('learning_standard_equivalence_association' not in params or
                params['learning_standard_equivalence_association'] is None):
