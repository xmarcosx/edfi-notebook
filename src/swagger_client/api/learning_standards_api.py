...
class LearningStandardsApi(object):
    ...
    def get_learning_standards_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if ('parent_learning_standard_id' in params and
        ...
        if ('learning_standard_category_descriptor' in params and
        ...
        if ('learning_standard_scope_descriptor' in params and
        ...
        if ('learning_standard_item_code' in params and
    ...
    def post_learning_standard_with_http_info(self, learning_standard, **kwargs):  # noqa: E501
        ...
        if ('learning_standard' not in params or
                params['learning_standard'] is None):
