...
class TpdmProspect(object):
    ...
    def prospect_type_descriptor(self, prospect_type_descriptor):
        ...
        :type: str
        """
        if prospect_type_descriptor is not None and len(prospect_type_descriptor) > 306:
    ...
    def referred_by(self, referred_by):
        ...
        :type: str
        """
        if referred_by is not None and len(referred_by) > 50:
    ...
    def social_media_network_name(self, social_media_network_name):
        ...
        :type: str
        """
        if social_media_network_name is not None and len(social_media_network_name) > 50:
    ...
    def social_media_user_name(self, social_media_user_name):
        ...
        :type: str
        """
        if social_media_user_name is not None and len(social_media_user_name) > 50:
