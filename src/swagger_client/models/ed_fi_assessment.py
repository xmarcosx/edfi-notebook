...
class EdFiAssessment(object):
    ...
    def assessment_category_descriptor(self, assessment_category_descriptor):
        ...
        :type: str
        """
        if assessment_category_descriptor is not None and len(assessment_category_descriptor) > 306:
    ...
    def assessment_family(self, assessment_family):
        ...
        :type: str
        """
        if assessment_family is not None and len(assessment_family) > 60:
    ...
    def assessment_form(self, assessment_form):
        ...
        :type: str
        """
        if assessment_form is not None and len(assessment_form) > 60:
    ...
    def assessment_title(self, assessment_title):
        ...
        :type: str
        """
        if assessment_title is None:
            raise ValueError("Invalid value for `assessment_title`, must not be `None`")  # noqa: E501
        if assessment_title is not None and len(assessment_title) > 100:
    ...
    def nomenclature(self, nomenclature):
        ...
        :type: str
        """
        if nomenclature is not None and len(nomenclature) > 35:
    ...
    @property
    def ext(self):
        """Gets the ext of this EdFiAssessment.  # noqa: E501


        :return: The ext of this EdFiAssessment.  # noqa: E501
        :rtype: AssessmentExtensions
        """
        return self._ext

    @ext.setter
    def ext(self, ext):
        """Sets the ext of this EdFiAssessment.


        :param ext: The ext of this EdFiAssessment.  # noqa: E501
        :type: AssessmentExtensions
        """
