...
class TpdmTeacherCandidateAcademicRecordClassRanking(object):
    ...
    def __init__(self, class_rank=None, class_ranking_date=None, percentage_ranking=None, total_number_in_class=None):  # noqa: E501
    ...
    def total_number_in_class(self, total_number_in_class):
        ...
        :type: int
        """
        if total_number_in_class is None:
