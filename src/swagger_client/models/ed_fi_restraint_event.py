...
class EdFiRestraintEvent(object):
    ...
    def __init__(self, id=None, restraint_event_identifier=None, school_reference=None, student_reference=None, educational_environment_descriptor=None, event_date=None, programs=None, reasons=None, etag=None):  # noqa: E501
    ...
    def restraint_event_identifier(self, restraint_event_identifier):
        ...
        :type: str
        """
        if restraint_event_identifier is None:
            raise ValueError("Invalid value for `restraint_event_identifier`, must not be `None`")  # noqa: E501
        if restraint_event_identifier is not None and len(restraint_event_identifier) > 20:
