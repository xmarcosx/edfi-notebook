...
class EdFiSectionAttendanceTakenEvent(object):
    ...
    def __init__(self, id=None, calendar_date_reference=None, section_reference=None, staff_reference=None, event_date=None, etag=None):  # noqa: E501
    ...
    def calendar_date_reference(self, calendar_date_reference):
        ...
        """
        if calendar_date_reference is None:
