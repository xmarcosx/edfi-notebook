...
class EdFiSurvey(object):
    ...
    def __init__(self, id=None, namespace=None, survey_identifier=None, education_organization_reference=None, school_year_type_reference=None, session_reference=None, number_administered=None, survey_category_descriptor=None, survey_title=None, etag=None):  # noqa: E501
    ...
    def survey_category_descriptor(self, survey_category_descriptor):
        ...
        :type: str
        """
        if survey_category_descriptor is not None and len(survey_category_descriptor) > 306:
    ...
    def survey_title(self, survey_title):
        ...
        if survey_title is not None and len(survey_title) > 255:
