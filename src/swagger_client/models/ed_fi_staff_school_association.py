...
class EdFiStaffSchoolAssociation(object):
    ...
    def __init__(self, id=None, program_assignment_descriptor=None, calendar_reference=None, school_reference=None, school_year_type_reference=None, staff_reference=None, academic_subjects=None, grade_levels=None, etag=None):  # noqa: E501
