...
class EdFiLocalEducationAgencyAccountability(object):
    ...
    def __init__(self, gun_free_schools_act_reporting_status_descriptor=None, school_choice_implement_status_descriptor=None, school_year_type_reference=None):  # noqa: E501
    ...
    def gun_free_schools_act_reporting_status_descriptor(self, gun_free_schools_act_reporting_status_descriptor):
        ...
        :type: str
        """
        if gun_free_schools_act_reporting_status_descriptor is not None and len(gun_free_schools_act_reporting_status_descriptor) > 306:
    ...
    def school_choice_implement_status_descriptor(self, school_choice_implement_status_descriptor):
        ...
        :type: str
        """
        if school_choice_implement_status_descriptor is not None and len(school_choice_implement_status_descriptor) > 306:
