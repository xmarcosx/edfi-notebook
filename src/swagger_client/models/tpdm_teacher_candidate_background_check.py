...
class TpdmTeacherCandidateBackgroundCheck(object):
    ...
    def __init__(self, background_check_status_descriptor=None, background_check_type_descriptor=None, background_check_completed_date=None, background_check_requested_date=None, fingerprint=None):  # noqa: E501
