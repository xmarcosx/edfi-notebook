...
class EdFiLearningStandard(object):
    ...
    def learning_standard_category_descriptor(self, learning_standard_category_descriptor):
        ...
        :type: str
        """
        if learning_standard_category_descriptor is not None and len(learning_standard_category_descriptor) > 306:
    ...
    def learning_standard_item_code(self, learning_standard_item_code):
        ...
        :type: str
        """
        if learning_standard_item_code is not None and len(learning_standard_item_code) > 60:
    ...
    def learning_standard_scope_descriptor(self, learning_standard_scope_descriptor):
        ...
        :type: str
        """
        if learning_standard_scope_descriptor is not None and len(learning_standard_scope_descriptor) > 306:
    ...
    def success_criteria(self, success_criteria):
        ...
        :type: str
        """
        if success_criteria is not None and len(success_criteria) > 150:
