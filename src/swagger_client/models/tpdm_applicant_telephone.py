...
class TpdmApplicantTelephone(object):
    ...
    def __init__(self, telephone_number_type_descriptor=None, telephone_number=None, do_not_publish_indicator=None, order_of_priority=None, text_message_capability_indicator=None):  # noqa: E501
        """TpdmApplicantTelephone - a model defined in Swagger"""  # noqa: E501
    ...
    def telephone_number_type_descriptor(self):
        """Gets the telephone_number_type_descriptor of this TpdmApplicantTelephone.  # noqa: E501

        The type of communication number listed for an individual or organization.  # noqa: E501

        :return: The telephone_number_type_descriptor of this TpdmApplicantTelephone.  # noqa: E501
        :rtype: str
        """
    ...
    def telephone_number_type_descriptor(self, telephone_number_type_descriptor):
        """Sets the telephone_number_type_descriptor of this TpdmApplicantTelephone.

        The type of communication number listed for an individual or organization.  # noqa: E501

        :param telephone_number_type_descriptor: The telephone_number_type_descriptor of this TpdmApplicantTelephone.  # noqa: E501
        :type: str
        """
    ...
    def telephone_number(self):
        """Gets the telephone_number of this TpdmApplicantTelephone.  # noqa: E501

        The telephone number including the area code, and extension, if applicable.  # noqa: E501

        :return: The telephone_number of this TpdmApplicantTelephone.  # noqa: E501
        :rtype: str
        """
    ...
    def telephone_number(self, telephone_number):
        """Sets the telephone_number of this TpdmApplicantTelephone.

        The telephone number including the area code, and extension, if applicable.  # noqa: E501

        :param telephone_number: The telephone_number of this TpdmApplicantTelephone.  # noqa: E501
        :type: str
        """
    ...
    def do_not_publish_indicator(self):
        """Gets the do_not_publish_indicator of this TpdmApplicantTelephone.  # noqa: E501

        An indication that the telephone number should not be published.  # noqa: E501

        :return: The do_not_publish_indicator of this TpdmApplicantTelephone.  # noqa: E501
        :rtype: bool
        """
    ...
    def do_not_publish_indicator(self, do_not_publish_indicator):
        """Sets the do_not_publish_indicator of this TpdmApplicantTelephone.

        An indication that the telephone number should not be published.  # noqa: E501

        :param do_not_publish_indicator: The do_not_publish_indicator of this TpdmApplicantTelephone.  # noqa: E501
        :type: bool
        """
    ...
    def order_of_priority(self):
        """Gets the order_of_priority of this TpdmApplicantTelephone.  # noqa: E501

        The order of priority assigned to telephone numbers to define which number to attempt first, second, etc.  # noqa: E501

        :return: The order_of_priority of this TpdmApplicantTelephone.  # noqa: E501
        :rtype: int
        """
    ...
    def order_of_priority(self, order_of_priority):
        """Sets the order_of_priority of this TpdmApplicantTelephone.

        The order of priority assigned to telephone numbers to define which number to attempt first, second, etc.  # noqa: E501

        :param order_of_priority: The order_of_priority of this TpdmApplicantTelephone.  # noqa: E501
        :type: int
        """
    ...
    def text_message_capability_indicator(self):
        """Gets the text_message_capability_indicator of this TpdmApplicantTelephone.  # noqa: E501
        ...
        :return: The text_message_capability_indicator of this TpdmApplicantTelephone.  # noqa: E501
        :rtype: bool
        """
    ...
    def text_message_capability_indicator(self, text_message_capability_indicator):
        """Sets the text_message_capability_indicator of this TpdmApplicantTelephone.

        An indication that the telephone number is technically capable of sending and receiving Short Message Service (SMS) text messages.  # noqa: E501

        :param text_message_capability_indicator: The text_message_capability_indicator of this TpdmApplicantTelephone.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmApplicantTelephone, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmApplicantTelephone):
            return False
