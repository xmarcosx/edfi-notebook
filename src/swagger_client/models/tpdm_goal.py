...
class TpdmGoal(object):
    ...
    def __init__(self, id=None, assignment_date=None, goal_title=None, evaluation_element_reference=None, person_reference=None, comments=None, completed_date=None, completed_indicator=None, due_date=None, goal_description=None, goal_type_descriptor=None, etag=None):  # noqa: E501
    ...
    def goal_title(self, goal_title):
        ...
        if goal_title is not None and len(goal_title) > 255:
    ...
    def goal_description(self, goal_description):
        ...
        :type: str
        """
        if goal_description is not None and len(goal_description) > 1024:
    ...
    def goal_type_descriptor(self, goal_type_descriptor):
        ...
        :type: str
        """
        if goal_type_descriptor is not None and len(goal_type_descriptor) > 306:
