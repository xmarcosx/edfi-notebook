...
class EdFiStudentLearningObjectiveReference(object):
    ...
    def __init__(self, grading_period_descriptor=None, grading_period_school_id=None, grading_period_school_year=None, grading_period_sequence=None, learning_objective_id=None, namespace=None, student_unique_id=None, link=None):  # noqa: E501
    ...
    def grading_period_descriptor(self, grading_period_descriptor):
        ...
        :type: str
        """
        if grading_period_descriptor is None:
            raise ValueError("Invalid value for `grading_period_descriptor`, must not be `None`")  # noqa: E501
        if grading_period_descriptor is not None and len(grading_period_descriptor) > 306:
    ...
    def grading_period_school_id(self, grading_period_school_id):
        ...
        :type: int
        """
        if grading_period_school_id is None:
    ...
    def grading_period_school_year(self, grading_period_school_year):
        ...
        :type: int
        """
        if grading_period_school_year is None:
    ...
    def grading_period_sequence(self, grading_period_sequence):
        ...
        :type: int
        """
        if grading_period_sequence is None:
    ...
    def learning_objective_id(self, learning_objective_id):
        ...
        :type: str
        """
        if learning_objective_id is None:
            raise ValueError("Invalid value for `learning_objective_id`, must not be `None`")  # noqa: E501
        if learning_objective_id is not None and len(learning_objective_id) > 60:
