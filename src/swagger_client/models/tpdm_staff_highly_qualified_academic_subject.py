...
class TpdmStaffHighlyQualifiedAcademicSubject(object):
    ...
    def __init__(self, academic_subject_descriptor=None):  # noqa: E501
        """TpdmStaffHighlyQualifiedAcademicSubject - a model defined in Swagger"""  # noqa: E501
    ...
    def academic_subject_descriptor(self):
        """Gets the academic_subject_descriptor of this TpdmStaffHighlyQualifiedAcademicSubject.  # noqa: E501

        The academic subject(s) in which the staff is deemed to be \"highly qualified\".  # noqa: E501

        :return: The academic_subject_descriptor of this TpdmStaffHighlyQualifiedAcademicSubject.  # noqa: E501
        :rtype: str
        """
    ...
    def academic_subject_descriptor(self, academic_subject_descriptor):
        """Sets the academic_subject_descriptor of this TpdmStaffHighlyQualifiedAcademicSubject.

        The academic subject(s) in which the staff is deemed to be \"highly qualified\".  # noqa: E501

        :param academic_subject_descriptor: The academic_subject_descriptor of this TpdmStaffHighlyQualifiedAcademicSubject.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmStaffHighlyQualifiedAcademicSubject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmStaffHighlyQualifiedAcademicSubject):
            return False
