...
class EdFiSurveyQuestionResponse(object):
    ...
    def __init__(self, id=None, survey_question_reference=None, survey_response_reference=None, comment=None, no_response=None, survey_question_matrix_element_responses=None, values=None, etag=None):  # noqa: E501
    ...
    def survey_question_reference(self, survey_question_reference):
        ...
        """
        if survey_question_reference is None:
