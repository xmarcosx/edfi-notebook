...
class EdFiReportCardReference(object):
    ...
    def __init__(self, education_organization_id=None, grading_period_descriptor=None, grading_period_school_id=None, grading_period_school_year=None, grading_period_sequence=None, student_unique_id=None, link=None):  # noqa: E501
