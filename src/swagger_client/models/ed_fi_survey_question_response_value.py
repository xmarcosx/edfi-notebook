...
class EdFiSurveyQuestionResponseValue(object):
    ...
    def __init__(self, survey_question_response_value_identifier=None, numeric_response=None, text_response=None):  # noqa: E501
    ...
    def survey_question_response_value_identifier(self, survey_question_response_value_identifier):
        ...
        :type: int
        """
        if survey_question_response_value_identifier is None:
