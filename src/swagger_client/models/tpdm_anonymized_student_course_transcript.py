...
class TpdmAnonymizedStudentCourseTranscript(object):
    ...
    def __init__(self, id=None, anonymized_student_academic_record_reference=None, course_reference=None, course_repeat_code_descriptor=None, course_title=None, final_letter_grade_earned=None, final_numeric_grade_earned=None, etag=None):  # noqa: E501
    ...
    def anonymized_student_academic_record_reference(self, anonymized_student_academic_record_reference):
        ...
        """
        if anonymized_student_academic_record_reference is None:
