...
class EdFiAccount(object):
    ...
    def __init__(self, id=None, account_codes=None, account_identifier=None, fiscal_year=None, education_organization_reference=None, account_name=None, etag=None):  # noqa: E501
    ...
    def account_identifier(self, account_identifier):
        ...
        if account_identifier is not None and len(account_identifier) > 50:
