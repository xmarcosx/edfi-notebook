...
class EdFiCalendar(object):
    ...
    def __init__(self, id=None, calendar_code=None, school_reference=None, school_year_type_reference=None, calendar_type_descriptor=None, grade_levels=None, etag=None):  # noqa: E501
    ...
    def calendar_type_descriptor(self, calendar_type_descriptor):
        ...
        :type: str
        """
        if calendar_type_descriptor is None:
            raise ValueError("Invalid value for `calendar_type_descriptor`, must not be `None`")  # noqa: E501
        if calendar_type_descriptor is not None and len(calendar_type_descriptor) > 306:
