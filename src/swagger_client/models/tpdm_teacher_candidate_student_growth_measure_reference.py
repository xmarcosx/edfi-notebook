...
class TpdmTeacherCandidateStudentGrowthMeasureReference(object):
    ...
    def __init__(self, fact_as_of_date=None, school_year=None, teacher_candidate_identifier=None, teacher_candidate_student_growth_measure_identifier=None, link=None):  # noqa: E501
    ...
    def teacher_candidate_student_growth_measure_identifier(self, teacher_candidate_student_growth_measure_identifier):
        ...
        :type: str
        """
        if teacher_candidate_student_growth_measure_identifier is None:
            raise ValueError("Invalid value for `teacher_candidate_student_growth_measure_identifier`, must not be `None`")  # noqa: E501
        if teacher_candidate_student_growth_measure_identifier is not None and len(teacher_candidate_student_growth_measure_identifier) > 64:
