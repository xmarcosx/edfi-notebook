...
class EdFiAssessmentItem(object):
    ...
    def assessment_item_category_descriptor(self, assessment_item_category_descriptor):
        ...
        :type: str
        """
        if assessment_item_category_descriptor is not None and len(assessment_item_category_descriptor) > 306:
    ...
    def assessment_item_uri(self, assessment_item_uri):
        ...
        :type: str
        """
        if assessment_item_uri is not None and len(assessment_item_uri) > 255:
    ...
    def correct_response(self, correct_response):
        ...
        :type: str
        """
        if correct_response is not None and len(correct_response) > 20:
    ...
    def expected_time_assessed(self, expected_time_assessed):
        ...
        :type: str
        """
        if expected_time_assessed is not None and len(expected_time_assessed) > 30:
    ...
    def item_text(self, item_text):
        ...
        :type: str
        """
        if item_text is not None and len(item_text) > 1024:
