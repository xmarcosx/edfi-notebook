...
class EdFiStaffAddress(object):
    ...
    def building_site_number(self):
        """Gets the building_site_number of this EdFiStaffAddress.  # noqa: E501

        The number of the building on the site, if more than one building shares the same address.  # noqa: E501

        :return: The building_site_number of this EdFiStaffAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def building_site_number(self, building_site_number):
        """Sets the building_site_number of this EdFiStaffAddress.

        The number of the building on the site, if more than one building shares the same address.  # noqa: E501

        :param building_site_number: The building_site_number of this EdFiStaffAddress.  # noqa: E501
        :type: str
        """
    ...
    def congressional_district(self):
        """Gets the congressional_district of this EdFiStaffAddress.  # noqa: E501

        The congressional district in which an address is located.  # noqa: E501

        :return: The congressional_district of this EdFiStaffAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def congressional_district(self, congressional_district):
        """Sets the congressional_district of this EdFiStaffAddress.

        The congressional district in which an address is located.  # noqa: E501

        :param congressional_district: The congressional_district of this EdFiStaffAddress.  # noqa: E501
        :type: str
        """
    ...
    def county_fips_code(self):
        """Gets the county_fips_code of this EdFiStaffAddress.  # noqa: E501
        ...
        :return: The county_fips_code of this EdFiStaffAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def county_fips_code(self, county_fips_code):
        """Sets the county_fips_code of this EdFiStaffAddress.

        The Federal Information Processing Standards (FIPS) numeric code for the county issued by the National Institute of Standards and Technology (NIST). Counties are considered to be the \"first-order subdivisions\" of each State and statistically equivalent entity, regardless of their local designations (county, parish, borough, etc.) Counties in different States will have the same code. A unique county number is created when combined with the 2-digit FIPS State Code.  # noqa: E501

        :param county_fips_code: The county_fips_code of this EdFiStaffAddress.  # noqa: E501
        :type: str
        """
    ...
    def do_not_publish_indicator(self):
        """Gets the do_not_publish_indicator of this EdFiStaffAddress.  # noqa: E501

        An indication that the address should not be published.  # noqa: E501

        :return: The do_not_publish_indicator of this EdFiStaffAddress.  # noqa: E501
        :rtype: bool
        """
    ...
    def do_not_publish_indicator(self, do_not_publish_indicator):
        """Sets the do_not_publish_indicator of this EdFiStaffAddress.

        An indication that the address should not be published.  # noqa: E501

        :param do_not_publish_indicator: The do_not_publish_indicator of this EdFiStaffAddress.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def latitude(self):
        """Gets the latitude of this EdFiStaffAddress.  # noqa: E501

        The geographic latitude of the physical address.  # noqa: E501

        :return: The latitude of this EdFiStaffAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def latitude(self, latitude):
        """Sets the latitude of this EdFiStaffAddress.

        The geographic latitude of the physical address.  # noqa: E501

        :param latitude: The latitude of this EdFiStaffAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def longitude(self):
        """Gets the longitude of this EdFiStaffAddress.  # noqa: E501

        The geographic longitude of the physical address.  # noqa: E501

        :return: The longitude of this EdFiStaffAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def longitude(self, longitude):
        """Sets the longitude of this EdFiStaffAddress.

        The geographic longitude of the physical address.  # noqa: E501

        :param longitude: The longitude of this EdFiStaffAddress.  # noqa: E501
        :type: str
        """
    ...
    def name_of_county(self):
        """Gets the name_of_county of this EdFiStaffAddress.  # noqa: E501

        The name of the county, parish, borough, or comparable unit (within a state) in                       'which an address is located.  # noqa: E501

        :return: The name_of_county of this EdFiStaffAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def name_of_county(self, name_of_county):
        """Sets the name_of_county of this EdFiStaffAddress.

        The name of the county, parish, borough, or comparable unit (within a state) in                       'which an address is located.  # noqa: E501

        :param name_of_county: The name_of_county of this EdFiStaffAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def periods(self):
        """Gets the periods of this EdFiStaffAddress.  # noqa: E501

        An unordered collection of staffAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.  # noqa: E501

        :return: The periods of this EdFiStaffAddress.  # noqa: E501
        :rtype: list[EdFiStaffAddressPeriod]
        """
        return self._periods

    @periods.setter
    def periods(self, periods):
        """Sets the periods of this EdFiStaffAddress.

        An unordered collection of staffAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.  # noqa: E501

        :param periods: The periods of this EdFiStaffAddress.  # noqa: E501
        :type: list[EdFiStaffAddressPeriod]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EdFiStaffAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdFiStaffAddress):
            return False
