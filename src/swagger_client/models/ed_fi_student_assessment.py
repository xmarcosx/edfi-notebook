...
class EdFiStudentAssessment(object):
    ...
    def student_assessment_identifier(self, student_assessment_identifier):
        ...
        :type: str
        """
        if student_assessment_identifier is None:
            raise ValueError("Invalid value for `student_assessment_identifier`, must not be `None`")  # noqa: E501
        if student_assessment_identifier is not None and len(student_assessment_identifier) > 60:
    ...
    def assessment_reference(self, assessment_reference):
        ...
        """
        if assessment_reference is None:
    ...
    def administration_date(self, administration_date):
        ...
        :type: datetime
        """
        if administration_date is None:
    ...
    def administration_environment_descriptor(self, administration_environment_descriptor):
        ...
        :type: str
        """
        if administration_environment_descriptor is not None and len(administration_environment_descriptor) > 306:
    ...
    def administration_language_descriptor(self, administration_language_descriptor):
        ...
        :type: str
        """
        if administration_language_descriptor is not None and len(administration_language_descriptor) > 306:
    ...
    def event_circumstance_descriptor(self, event_circumstance_descriptor):
        ...
        :type: str
        """
        if event_circumstance_descriptor is not None and len(event_circumstance_descriptor) > 306:
    ...
    def event_description(self, event_description):
        ...
        :type: str
        """
        if event_description is not None and len(event_description) > 1024:
    ...
    def platform_type_descriptor(self, platform_type_descriptor):
        ...
        :type: str
        """
        if platform_type_descriptor is not None and len(platform_type_descriptor) > 306:
    ...
    def reason_not_tested_descriptor(self, reason_not_tested_descriptor):
        ...
        :type: str
        """
        if reason_not_tested_descriptor is not None and len(reason_not_tested_descriptor) > 306:
    ...
    def retest_indicator_descriptor(self, retest_indicator_descriptor):
        ...
        :type: str
        """
        if retest_indicator_descriptor is not None and len(retest_indicator_descriptor) > 306:
    ...
    def serial_number(self, serial_number):
        ...
        :type: str
        """
        if serial_number is not None and len(serial_number) > 60:
    ...
    def when_assessed_grade_level_descriptor(self, when_assessed_grade_level_descriptor):
        ...
        :type: str
        """
        if when_assessed_grade_level_descriptor is not None and len(when_assessed_grade_level_descriptor) > 306:
