...
class EdFiStaff(object):
    ...
    def __init__(self, id=None, staff_unique_id=None, person_reference=None, addresses=None, birth_date=None, citizenship_status_descriptor=None, credentials=None, electronic_mails=None, first_name=None, generation_code_suffix=None, highest_completed_level_of_education_descriptor=None, highly_qualified_teacher=None, hispanic_latino_ethnicity=None, identification_codes=None, identification_documents=None, international_addresses=None, languages=None, last_surname=None, login_id=None, maiden_name=None, middle_name=None, old_ethnicity_descriptor=None, other_names=None, personal_identification_documents=None, personal_title_prefix=None, races=None, recognitions=None, sex_descriptor=None, telephones=None, tribal_affiliations=None, visas=None, years_of_prior_professional_experience=None, years_of_prior_teaching_experience=None, etag=None, ext=None):  # noqa: E501
    ...
    def staff_unique_id(self, staff_unique_id):
        ...
        :type: str
        """
        if staff_unique_id is None:
            raise ValueError("Invalid value for `staff_unique_id`, must not be `None`")  # noqa: E501
        if staff_unique_id is not None and len(staff_unique_id) > 32:
    ...
    def highest_completed_level_of_education_descriptor(self, highest_completed_level_of_education_descriptor):
        ...
        :type: str
        """
        if highest_completed_level_of_education_descriptor is not None and len(highest_completed_level_of_education_descriptor) > 306:
    ...
    @property
    def ext(self):
        """Gets the ext of this EdFiStaff.  # noqa: E501


        :return: The ext of this EdFiStaff.  # noqa: E501
        :rtype: StaffExtensions
        """
        return self._ext

    @ext.setter
    def ext(self, ext):
        """Sets the ext of this EdFiStaff.


        :param ext: The ext of this EdFiStaff.  # noqa: E501
        :type: StaffExtensions
        """
