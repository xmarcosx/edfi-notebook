...
class EdFiCredentialReference(object):
    ...
    def __init__(self, credential_identifier=None, state_of_issue_state_abbreviation_descriptor=None, link=None):  # noqa: E501
    ...
    def credential_identifier(self, credential_identifier):
        ...
        if credential_identifier is not None and len(credential_identifier) > 60:
    ...
    def state_of_issue_state_abbreviation_descriptor(self, state_of_issue_state_abbreviation_descriptor):
        ...
        :type: str
        """
        if state_of_issue_state_abbreviation_descriptor is None:
            raise ValueError("Invalid value for `state_of_issue_state_abbreviation_descriptor`, must not be `None`")  # noqa: E501
        if state_of_issue_state_abbreviation_descriptor is not None and len(state_of_issue_state_abbreviation_descriptor) > 306:
