...
class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment(object):
    ...
    def __init__(self, monitored_descriptor=None, participation_descriptor=None, proficiency_descriptor=None, progress_descriptor=None, school_year_type_reference=None):  # noqa: E501
    ...
    def monitored_descriptor(self, monitored_descriptor):
        ...
        :type: str
        """
        if monitored_descriptor is not None and len(monitored_descriptor) > 306:
    ...
    def participation_descriptor(self, participation_descriptor):
        ...
        :type: str
        """
        if participation_descriptor is not None and len(participation_descriptor) > 306:
    ...
    def proficiency_descriptor(self, proficiency_descriptor):
        ...
        :type: str
        """
        if proficiency_descriptor is not None and len(proficiency_descriptor) > 306:
    ...
    def progress_descriptor(self, progress_descriptor):
        ...
        :type: str
        """
        if progress_descriptor is not None and len(progress_descriptor) > 306:
