...
class EdFiStudentInterventionAttendanceEvent(object):
    ...
    def __init__(self, id=None, attendance_event_category_descriptor=None, event_date=None, intervention_reference=None, student_reference=None, attendance_event_reason=None, educational_environment_descriptor=None, event_duration=None, intervention_duration=None, etag=None):  # noqa: E501
    ...
    def attendance_event_category_descriptor(self, attendance_event_category_descriptor):
        ...
        :type: str
        """
        if attendance_event_category_descriptor is None:
            raise ValueError("Invalid value for `attendance_event_category_descriptor`, must not be `None`")  # noqa: E501
        if attendance_event_category_descriptor is not None and len(attendance_event_category_descriptor) > 306:
    ...
    def attendance_event_reason(self, attendance_event_reason):
        ...
        :type: str
        """
        if attendance_event_reason is not None and len(attendance_event_reason) > 255:
