...
class TpdmApplicationScoreResult(object):
    ...
    def __init__(self, assessment_reporting_method_descriptor=None, result_datatype_type_descriptor=None, result=None):  # noqa: E501
        """TpdmApplicationScoreResult - a model defined in Swagger"""  # noqa: E501
    ...
    def assessment_reporting_method_descriptor(self):
        """Gets the assessment_reporting_method_descriptor of this TpdmApplicationScoreResult.  # noqa: E501
        ...
        :return: The assessment_reporting_method_descriptor of this TpdmApplicationScoreResult.  # noqa: E501
        :rtype: str
        """
    ...
    def assessment_reporting_method_descriptor(self, assessment_reporting_method_descriptor):
        """Sets the assessment_reporting_method_descriptor of this TpdmApplicationScoreResult.

        The method that the administrator of the assessment uses to report the performance and achievement of all students. It may be a qualitative method such as performance level descriptors or a quantitative method such as a numerical grade or cut score. More than one type of reporting method may be used.  # noqa: E501

        :param assessment_reporting_method_descriptor: The assessment_reporting_method_descriptor of this TpdmApplicationScoreResult.  # noqa: E501
        :type: str
        """
    ...
    def result_datatype_type_descriptor(self):
        """Gets the result_datatype_type_descriptor of this TpdmApplicationScoreResult.  # noqa: E501

        The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.  # noqa: E501

        :return: The result_datatype_type_descriptor of this TpdmApplicationScoreResult.  # noqa: E501
        :rtype: str
        """
    ...
    def result_datatype_type_descriptor(self, result_datatype_type_descriptor):
        """Sets the result_datatype_type_descriptor of this TpdmApplicationScoreResult.

        The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.  # noqa: E501

        :param result_datatype_type_descriptor: The result_datatype_type_descriptor of this TpdmApplicationScoreResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def result(self):
        """Gets the result of this TpdmApplicationScoreResult.  # noqa: E501
        ...
        :return: The result of this TpdmApplicationScoreResult.  # noqa: E501
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        """Sets the result of this TpdmApplicationScoreResult.

        The value of a meaningful raw score or statistical expression of the performance of an individual. The results can be expressed as a number, percentile, range, level, etc.  # noqa: E501

        :param result: The result of this TpdmApplicationScoreResult.  # noqa: E501
        :type: str
        """
        if result is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmApplicationScoreResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmApplicationScoreResult):
            return False
