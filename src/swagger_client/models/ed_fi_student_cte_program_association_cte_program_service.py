...
class EdFiStudentCTEProgramAssociationCTEProgramService(object):
    ...
    def __init__(self, cte_program_service_descriptor=None, cip_code=None, primary_indicator=None, service_begin_date=None, service_end_date=None):  # noqa: E501
    ...
    def cte_program_service_descriptor(self, cte_program_service_descriptor):
        ...
        :type: str
        """
        if cte_program_service_descriptor is None:
            raise ValueError("Invalid value for `cte_program_service_descriptor`, must not be `None`")  # noqa: E501
        if cte_program_service_descriptor is not None and len(cte_program_service_descriptor) > 306:
