...
class EdFiStudentSectionAttendanceEvent(object):
    ...
    def __init__(self, id=None, attendance_event_category_descriptor=None, event_date=None, section_reference=None, student_reference=None, arrival_time=None, attendance_event_reason=None, departure_time=None, educational_environment_descriptor=None, event_duration=None, section_attendance_duration=None, etag=None):  # noqa: E501
