...
class EdFiCourseOffering(object):
    ...
    def __init__(self, id=None, local_course_code=None, course_reference=None, school_reference=None, session_reference=None, course_level_characteristics=None, curriculum_useds=None, instructional_time_planned=None, local_course_title=None, offered_grade_levels=None, etag=None):  # noqa: E501
    ...
    def local_course_title(self, local_course_title):
        ...
        :type: str
        """
        if local_course_title is not None and len(local_course_title) > 60:
