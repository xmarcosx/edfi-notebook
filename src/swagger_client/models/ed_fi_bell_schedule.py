...
class EdFiBellSchedule(object):
    ...
    def __init__(self, id=None, bell_schedule_name=None, class_periods=None, school_reference=None, alternate_day_name=None, dates=None, end_time=None, grade_levels=None, start_time=None, total_instructional_time=None, etag=None):  # noqa: E501
    ...
    def bell_schedule_name(self, bell_schedule_name):
        ...
        :type: str
        """
        if bell_schedule_name is None:
            raise ValueError("Invalid value for `bell_schedule_name`, must not be `None`")  # noqa: E501
        if bell_schedule_name is not None and len(bell_schedule_name) > 60:
    ...
    def alternate_day_name(self, alternate_day_name):
        ...
        :type: str
        """
        if alternate_day_name is not None and len(alternate_day_name) > 20:
