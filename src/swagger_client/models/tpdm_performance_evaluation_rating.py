...
class TpdmPerformanceEvaluationRating(object):
    ...
    def __init__(self, id=None, performance_evaluation_reference=None, person_reference=None, actual_date=None, actual_duration=None, actual_time=None, announced=None, comments=None, coteaching_style_observed_descriptor=None, performance_evaluation_rating_level_descriptor=None, results=None, reviewers=None, schedule_date=None, etag=None):  # noqa: E501
    ...
    def coteaching_style_observed_descriptor(self, coteaching_style_observed_descriptor):
        ...
        :type: str
        """
        if coteaching_style_observed_descriptor is not None and len(coteaching_style_observed_descriptor) > 306:
    ...
    def performance_evaluation_rating_level_descriptor(self, performance_evaluation_rating_level_descriptor):
        ...
        :type: str
        """
        if performance_evaluation_rating_level_descriptor is not None and len(performance_evaluation_rating_level_descriptor) > 306:
