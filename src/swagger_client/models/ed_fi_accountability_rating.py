...
class EdFiAccountabilityRating(object):
    ...
    def __init__(self, id=None, rating_title=None, education_organization_reference=None, school_year_type_reference=None, rating=None, rating_date=None, rating_organization=None, rating_program=None, etag=None):  # noqa: E501
    ...
    def rating_title(self, rating_title):
        ...
        if rating_title is not None and len(rating_title) > 60:
    ...
    def rating(self, rating):
        ...
        if rating is not None and len(rating) > 35:
    ...
    def rating_organization(self, rating_organization):
        ...
        :type: str
        """
        if rating_organization is not None and len(rating_organization) > 35:
    ...
    def rating_program(self, rating_program):
        ...
        :type: str
        """
        if rating_program is not None and len(rating_program) > 30:
