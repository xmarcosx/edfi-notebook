...
class EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService(object):
    ...
    def __init__(self, language_instruction_program_service_descriptor=None, primary_indicator=None, service_begin_date=None, service_end_date=None):  # noqa: E501
    ...
    def language_instruction_program_service_descriptor(self, language_instruction_program_service_descriptor):
        ...
        :type: str
        """
        if language_instruction_program_service_descriptor is None:
            raise ValueError("Invalid value for `language_instruction_program_service_descriptor`, must not be `None`")  # noqa: E501
        if language_instruction_program_service_descriptor is not None and len(language_instruction_program_service_descriptor) > 306:
