...
class TpdmApplicantStaffIdentificationCode(object):
    ...
    def __init__(self, staff_identification_system_descriptor=None, assigning_organization_identification_code=None, identification_code=None):  # noqa: E501
        """TpdmApplicantStaffIdentificationCode - a model defined in Swagger"""  # noqa: E501
    ...
    def staff_identification_system_descriptor(self):
        """Gets the staff_identification_system_descriptor of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        ...
        :return: The staff_identification_system_descriptor of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        :rtype: str
        """
    ...
    def staff_identification_system_descriptor(self, staff_identification_system_descriptor):
        """Sets the staff_identification_system_descriptor of this TpdmApplicantStaffIdentificationCode.

        A coding scheme that is used for identification and record-keeping purposes by schools, social services, or other agencies to refer to a staff member.  # noqa: E501

        :param staff_identification_system_descriptor: The staff_identification_system_descriptor of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        :type: str
        """
        if staff_identification_system_descriptor is None:
            raise ValueError("Invalid value for `staff_identification_system_descriptor`, must not be `None`")  # noqa: E501
        if staff_identification_system_descriptor is not None and len(staff_identification_system_descriptor) > 306:
    ...
    def assigning_organization_identification_code(self):
        """Gets the assigning_organization_identification_code of this TpdmApplicantStaffIdentificationCode.  # noqa: E501

        The organization code or name assigning the staff Identification Code.  # noqa: E501

        :return: The assigning_organization_identification_code of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        :rtype: str
        """
    ...
    def assigning_organization_identification_code(self, assigning_organization_identification_code):
        """Sets the assigning_organization_identification_code of this TpdmApplicantStaffIdentificationCode.

        The organization code or name assigning the staff Identification Code.  # noqa: E501

        :param assigning_organization_identification_code: The assigning_organization_identification_code of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        :type: str
        """
    ...
    def identification_code(self):
        """Gets the identification_code of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        ...
        :return: The identification_code of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        :rtype: str
        """
    ...
    def identification_code(self, identification_code):
        """Sets the identification_code of this TpdmApplicantStaffIdentificationCode.

        A unique number or alphanumeric code assigned to a staff member by a school, school system, a state, or other agency or entity.  # noqa: E501

        :param identification_code: The identification_code of this TpdmApplicantStaffIdentificationCode.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmApplicantStaffIdentificationCode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmApplicantStaffIdentificationCode):
            return False
