...
class EdFiStudentSectionAssociation(object):
    ...
    def __init__(self, id=None, begin_date=None, section_reference=None, student_reference=None, attempt_status_descriptor=None, end_date=None, homeroom_indicator=None, repeat_identifier_descriptor=None, teacher_student_data_link_exclusion=None, etag=None):  # noqa: E501
    ...
    def attempt_status_descriptor(self, attempt_status_descriptor):
        ...
        :type: str
        """
        if attempt_status_descriptor is not None and len(attempt_status_descriptor) > 306:
    ...
    def repeat_identifier_descriptor(self, repeat_identifier_descriptor):
        ...
        :type: str
        """
        if repeat_identifier_descriptor is not None and len(repeat_identifier_descriptor) > 306:
