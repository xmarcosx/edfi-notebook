...
class EdFiGraduationPlanCreditsByCourse(object):
    ...
    def __init__(self, course_set_name=None, credit_type_descriptor=None, when_taken_grade_level_descriptor=None, credit_conversion=None, credits=None, courses=None):  # noqa: E501
    ...
    def course_set_name(self, course_set_name):
        ...
        :type: str
        """
        if course_set_name is None:
            raise ValueError("Invalid value for `course_set_name`, must not be `None`")  # noqa: E501
        if course_set_name is not None and len(course_set_name) > 120:
