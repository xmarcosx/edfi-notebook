...
class EdFiGrade(object):
    ...
    def __init__(self, id=None, grade_type_descriptor=None, grading_period_reference=None, student_section_association_reference=None, diagnostic_statement=None, learning_standard_grades=None, letter_grade_earned=None, numeric_grade_earned=None, performance_base_conversion_descriptor=None, etag=None):  # noqa: E501
