...
class EdFiLocalEducationAgencyFederalFunds(object):
    ...
    def fiscal_year(self):
        ...
        The school year for which the accountability is reported.  # noqa: E501
