...
class TpdmAnonymizedStudent(object):
    ...
    def __init__(self, id=None, anonymized_student_identifier=None, facts_as_of_date=None, school_year_type_reference=None, atrisk_indicator=None, disabilities=None, ell_enrollment=None, esl_enrollment=None, gender_descriptor=None, grade_level_descriptor=None, hispanic_latino_ethnicity=None, languages=None, mobility=None, races=None, section504_enrollment=None, sex_descriptor=None, sped_enrollment=None, title_i_enrollment=None, value_type_descriptor=None, etag=None):  # noqa: E501
    ...
    def value_type_descriptor(self, value_type_descriptor):
        ...
        :type: str
        """
        if value_type_descriptor is not None and len(value_type_descriptor) > 306:
