...
class EdFiAssessmentScore(object):
    ...
    def __init__(self, assessment_reporting_method_descriptor=None, result_datatype_type_descriptor=None, maximum_score=None, minimum_score=None):  # noqa: E501
        """EdFiAssessmentScore - a model defined in Swagger"""  # noqa: E501
    ...
    def assessment_reporting_method_descriptor(self):
        """Gets the assessment_reporting_method_descriptor of this EdFiAssessmentScore.  # noqa: E501
        ...
        :return: The assessment_reporting_method_descriptor of this EdFiAssessmentScore.  # noqa: E501
        :rtype: str
        """
    ...
    def assessment_reporting_method_descriptor(self, assessment_reporting_method_descriptor):
        """Sets the assessment_reporting_method_descriptor of this EdFiAssessmentScore.

        The method that the administrator of the assessment uses to report the performance and achievement of all students. It may be a qualitative method such as performance level descriptors or a quantitative method such as a numerical grade or cut score. More than one type of reporting method may be used.  # noqa: E501

        :param assessment_reporting_method_descriptor: The assessment_reporting_method_descriptor of this EdFiAssessmentScore.  # noqa: E501
        :type: str
        """
    ...
    def result_datatype_type_descriptor(self):
        """Gets the result_datatype_type_descriptor of this EdFiAssessmentScore.  # noqa: E501

        The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.  # noqa: E501

        :return: The result_datatype_type_descriptor of this EdFiAssessmentScore.  # noqa: E501
        :rtype: str
        """
    ...
    def result_datatype_type_descriptor(self, result_datatype_type_descriptor):
        """Sets the result_datatype_type_descriptor of this EdFiAssessmentScore.

        The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.  # noqa: E501

        :param result_datatype_type_descriptor: The result_datatype_type_descriptor of this EdFiAssessmentScore.  # noqa: E501
        :type: str
        """
    ...
    def maximum_score(self):
        """Gets the maximum_score of this EdFiAssessmentScore.  # noqa: E501

        The maximum score possible on the assessment.  # noqa: E501

        :return: The maximum_score of this EdFiAssessmentScore.  # noqa: E501
        :rtype: str
        """
    ...
    def maximum_score(self, maximum_score):
        """Sets the maximum_score of this EdFiAssessmentScore.

        The maximum score possible on the assessment.  # noqa: E501

        :param maximum_score: The maximum_score of this EdFiAssessmentScore.  # noqa: E501
        :type: str
        """
    ...
    def minimum_score(self):
        """Gets the minimum_score of this EdFiAssessmentScore.  # noqa: E501

        The minimum score possible on the assessment.  # noqa: E501

        :return: The minimum_score of this EdFiAssessmentScore.  # noqa: E501
        :rtype: str
        """
    ...
    def minimum_score(self, minimum_score):
        """Sets the minimum_score of this EdFiAssessmentScore.

        The minimum score possible on the assessment.  # noqa: E501

        :param minimum_score: The minimum_score of this EdFiAssessmentScore.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EdFiAssessmentScore, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdFiAssessmentScore):
            return False
