...
class TpdmApplication(object):
    ...
    def application_source_descriptor(self, application_source_descriptor):
        ...
        :type: str
        """
        if application_source_descriptor is not None and len(application_source_descriptor) > 306:
    ...
    def application_status_descriptor(self, application_status_descriptor):
        ...
        :type: str
        """
        if application_status_descriptor is None:
            raise ValueError("Invalid value for `application_status_descriptor`, must not be `None`")  # noqa: E501
        if application_status_descriptor is not None and len(application_status_descriptor) > 306:
    ...
    def highly_qualified_academic_subject_descriptor(self, highly_qualified_academic_subject_descriptor):
        ...
        :type: str
        """
        if highly_qualified_academic_subject_descriptor is not None and len(highly_qualified_academic_subject_descriptor) > 306:
    ...
    def high_needs_academic_subject_descriptor(self, high_needs_academic_subject_descriptor):
        ...
        :type: str
        """
        if high_needs_academic_subject_descriptor is not None and len(high_needs_academic_subject_descriptor) > 306:
    ...
    def hire_status_descriptor(self, hire_status_descriptor):
        ...
        :type: str
        """
        if hire_status_descriptor is not None and len(hire_status_descriptor) > 306:
    ...
    def hiring_source_descriptor(self, hiring_source_descriptor):
        ...
        :type: str
        """
        if hiring_source_descriptor is not None and len(hiring_source_descriptor) > 306:
    ...
    def withdraw_reason_descriptor(self, withdraw_reason_descriptor):
        ...
        :type: str
        """
        if withdraw_reason_descriptor is not None and len(withdraw_reason_descriptor) > 306:
