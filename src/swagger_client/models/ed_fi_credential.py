...
class EdFiCredential(object):
    ...
    def __init__(self, id=None, credential_identifier=None, grade_levels=None, state_of_issue_state_abbreviation_descriptor=None, academic_subjects=None, credential_field_descriptor=None, credential_type_descriptor=None, effective_date=None, endorsements=None, expiration_date=None, issuance_date=None, namespace=None, teaching_credential_basis_descriptor=None, teaching_credential_descriptor=None, etag=None, ext=None):  # noqa: E501
    ...
    def credential_type_descriptor(self, credential_type_descriptor):
        ...
        :type: str
        """
        if credential_type_descriptor is None:
            raise ValueError("Invalid value for `credential_type_descriptor`, must not be `None`")  # noqa: E501
        if credential_type_descriptor is not None and len(credential_type_descriptor) > 306:
    ...
    def teaching_credential_basis_descriptor(self, teaching_credential_basis_descriptor):
        ...
        :type: str
        """
        if teaching_credential_basis_descriptor is not None and len(teaching_credential_basis_descriptor) > 306:
    ...
    def teaching_credential_descriptor(self, teaching_credential_descriptor):
        ...
        :type: str
        """
        if teaching_credential_descriptor is None:
            raise ValueError("Invalid value for `teaching_credential_descriptor`, must not be `None`")  # noqa: E501
        if teaching_credential_descriptor is not None and len(teaching_credential_descriptor) > 306:
