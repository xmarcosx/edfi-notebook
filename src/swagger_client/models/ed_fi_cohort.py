...
class EdFiCohort(object):
    ...
    def __init__(self, id=None, cohort_identifier=None, education_organization_reference=None, academic_subject_descriptor=None, cohort_description=None, cohort_scope_descriptor=None, cohort_type_descriptor=None, programs=None, etag=None):  # noqa: E501
    ...
    def cohort_description(self, cohort_description):
        ...
        :type: str
        """
        if cohort_description is not None and len(cohort_description) > 1024:
    ...
    def cohort_scope_descriptor(self, cohort_scope_descriptor):
        ...
        :type: str
        """
        if cohort_scope_descriptor is not None and len(cohort_scope_descriptor) > 306:
    ...
    def cohort_type_descriptor(self, cohort_type_descriptor):
        ...
        :type: str
        """
        if cohort_type_descriptor is None:
            raise ValueError("Invalid value for `cohort_type_descriptor`, must not be `None`")  # noqa: E501
        if cohort_type_descriptor is not None and len(cohort_type_descriptor) > 306:
