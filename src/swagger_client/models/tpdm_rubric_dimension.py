...
class TpdmRubricDimension(object):
    ...
    def __init__(self, id=None, rubric_rating=None, evaluation_element_reference=None, criterion_description=None, dimension_order=None, rubric_rating_level_descriptor=None, etag=None):  # noqa: E501
    ...
    def criterion_description(self, criterion_description):
        ...
        :type: str
        """
        if criterion_description is None:
            raise ValueError("Invalid value for `criterion_description`, must not be `None`")  # noqa: E501
        if criterion_description is not None and len(criterion_description) > 1024:
    ...
    def rubric_rating_level_descriptor(self, rubric_rating_level_descriptor):
        ...
        :type: str
        """
        if rubric_rating_level_descriptor is not None and len(rubric_rating_level_descriptor) > 306:
