...
class EdFiStudentParentAssociation(object):
    ...
    def __init__(self, id=None, parent_reference=None, student_reference=None, contact_priority=None, contact_restrictions=None, emergency_contact_status=None, lives_with=None, primary_contact_status=None, relation_descriptor=None, etag=None):  # noqa: E501
    ...
    def contact_restrictions(self, contact_restrictions):
        ...
        :type: str
        """
        if contact_restrictions is not None and len(contact_restrictions) > 250:
    ...
    def relation_descriptor(self):
        ...
        The nature of an individual's relationship to a student; for example:         Father, Mother, Step Father, Step Mother, Foster Father, Foster Mother, Guardian, etc.  # noqa: E501
    ...
    def relation_descriptor(self, relation_descriptor):
        ...
        :type: str
        """
        if relation_descriptor is not None and len(relation_descriptor) > 306:
