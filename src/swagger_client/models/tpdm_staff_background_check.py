...
class TpdmStaffBackgroundCheck(object):
    ...
    def __init__(self, background_check_type_descriptor=None, background_check_status_descriptor=None, background_check_completed_date=None, background_check_requested_date=None, fingerprint=None):  # noqa: E501
        """TpdmStaffBackgroundCheck - a model defined in Swagger"""  # noqa: E501
    ...
    def background_check_type_descriptor(self):
        """Gets the background_check_type_descriptor of this TpdmStaffBackgroundCheck.  # noqa: E501

        The type of background check (e.g., online, criminal, employment).  # noqa: E501

        :return: The background_check_type_descriptor of this TpdmStaffBackgroundCheck.  # noqa: E501
        :rtype: str
        """
    ...
    def background_check_type_descriptor(self, background_check_type_descriptor):
        """Sets the background_check_type_descriptor of this TpdmStaffBackgroundCheck.

        The type of background check (e.g., online, criminal, employment).  # noqa: E501

        :param background_check_type_descriptor: The background_check_type_descriptor of this TpdmStaffBackgroundCheck.  # noqa: E501
        :type: str
        """
    ...
    def background_check_status_descriptor(self):
        """Gets the background_check_status_descriptor of this TpdmStaffBackgroundCheck.  # noqa: E501

        The status of the background check (e.g., pending, under investigation, offense(s) found, etc.).  # noqa: E501

        :return: The background_check_status_descriptor of this TpdmStaffBackgroundCheck.  # noqa: E501
        :rtype: str
        """
    ...
    def background_check_status_descriptor(self, background_check_status_descriptor):
        """Sets the background_check_status_descriptor of this TpdmStaffBackgroundCheck.

        The status of the background check (e.g., pending, under investigation, offense(s) found, etc.).  # noqa: E501

        :param background_check_status_descriptor: The background_check_status_descriptor of this TpdmStaffBackgroundCheck.  # noqa: E501
        :type: str
        """
    ...
    def background_check_completed_date(self):
        """Gets the background_check_completed_date of this TpdmStaffBackgroundCheck.  # noqa: E501

        The date the background check was completed.  # noqa: E501

        :return: The background_check_completed_date of this TpdmStaffBackgroundCheck.  # noqa: E501
        :rtype: date
        """
    ...
    def background_check_completed_date(self, background_check_completed_date):
        """Sets the background_check_completed_date of this TpdmStaffBackgroundCheck.

        The date the background check was completed.  # noqa: E501

        :param background_check_completed_date: The background_check_completed_date of this TpdmStaffBackgroundCheck.  # noqa: E501
        :type: date
        """
    ...
    def background_check_requested_date(self):
        """Gets the background_check_requested_date of this TpdmStaffBackgroundCheck.  # noqa: E501

        The date the background check was requested.  # noqa: E501

        :return: The background_check_requested_date of this TpdmStaffBackgroundCheck.  # noqa: E501
        :rtype: date
        """
    ...
    def background_check_requested_date(self, background_check_requested_date):
        """Sets the background_check_requested_date of this TpdmStaffBackgroundCheck.

        The date the background check was requested.  # noqa: E501

        :param background_check_requested_date: The background_check_requested_date of this TpdmStaffBackgroundCheck.  # noqa: E501
        :type: date
        """
    ...
    def fingerprint(self):
        """Gets the fingerprint of this TpdmStaffBackgroundCheck.  # noqa: E501

        Indicates that a person has or has not completed a fingerprint.  # noqa: E501

        :return: The fingerprint of this TpdmStaffBackgroundCheck.  # noqa: E501
        :rtype: bool
        """
    ...
    def fingerprint(self, fingerprint):
        """Sets the fingerprint of this TpdmStaffBackgroundCheck.

        Indicates that a person has or has not completed a fingerprint.  # noqa: E501

        :param fingerprint: The fingerprint of this TpdmStaffBackgroundCheck.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmStaffBackgroundCheck, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmStaffBackgroundCheck):
            return False
