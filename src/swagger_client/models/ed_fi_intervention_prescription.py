...
class EdFiInterventionPrescription(object):
    ...
    def __init__(self, id=None, intervention_prescription_identification_code=None, education_organization_reference=None, appropriate_grade_levels=None, appropriate_sexes=None, delivery_method_descriptor=None, diagnoses=None, education_contents=None, intervention_class_descriptor=None, learning_resource_metadata_ur_is=None, max_dosage=None, min_dosage=None, population_serveds=None, uris=None, etag=None):  # noqa: E501
    ...
    def delivery_method_descriptor(self, delivery_method_descriptor):
        ...
        :type: str
        """
        if delivery_method_descriptor is None:
            raise ValueError("Invalid value for `delivery_method_descriptor`, must not be `None`")  # noqa: E501
        if delivery_method_descriptor is not None and len(delivery_method_descriptor) > 306:
    ...
    def intervention_class_descriptor(self, intervention_class_descriptor):
        ...
        :type: str
        """
        if intervention_class_descriptor is None:
            raise ValueError("Invalid value for `intervention_class_descriptor`, must not be `None`")  # noqa: E501
        if intervention_class_descriptor is not None and len(intervention_class_descriptor) > 306:
