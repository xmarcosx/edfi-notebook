...
class TpdmCredentialExtension(object):
    ...
    def __init__(self, certification_route_descriptor=None, credential_status_descriptor=None, board_certification_indicator=None, certification_title=None, credential_status_date=None, certification_reference=None, person_reference=None, student_academic_records=None):  # noqa: E501
    ...
    def credential_status_descriptor(self, credential_status_descriptor):
        ...
        :type: str
        """
        if credential_status_descriptor is not None and len(credential_status_descriptor) > 306:
