...
class EdFiProgram(object):
    ...
    def __init__(self, id=None, program_name=None, program_type_descriptor=None, education_organization_reference=None, characteristics=None, learning_objectives=None, learning_standards=None, program_id=None, services=None, sponsors=None, etag=None):  # noqa: E501
