...
class EdFiStudentAssessmentItem(object):
    ...
    def __init__(self, assessment_item_result_descriptor=None, response_indicator_descriptor=None, assessment_response=None, descriptive_feedback=None, raw_score_result=None, time_assessed=None, assessment_item_reference=None):  # noqa: E501
    ...
    def assessment_item_result_descriptor(self, assessment_item_result_descriptor):
        ...
        :type: str
        """
        if assessment_item_result_descriptor is None:
            raise ValueError("Invalid value for `assessment_item_result_descriptor`, must not be `None`")  # noqa: E501
        if assessment_item_result_descriptor is not None and len(assessment_item_result_descriptor) > 306:
    ...
    def response_indicator_descriptor(self, response_indicator_descriptor):
        ...
        :type: str
        """
        if response_indicator_descriptor is not None and len(response_indicator_descriptor) > 306:
    ...
    def assessment_response(self, assessment_response):
        ...
        :type: str
        """
        if assessment_response is not None and len(assessment_response) > 60:
    ...
    def descriptive_feedback(self, descriptive_feedback):
        ...
        :type: str
        """
        if descriptive_feedback is not None and len(descriptive_feedback) > 1024:
    ...
    def time_assessed(self, time_assessed):
        ...
        :type: str
        """
        if time_assessed is not None and len(time_assessed) > 30:
