...
class EdFiGraduationPlan(object):
    ...
    def graduation_school_year_type_reference(self, graduation_school_year_type_reference):
        ...
        """
        if graduation_school_year_type_reference is None:
    ...
    def total_required_credit_type_descriptor(self, total_required_credit_type_descriptor):
        ...
        :type: str
        """
        if total_required_credit_type_descriptor is not None and len(total_required_credit_type_descriptor) > 306:
    ...
    @property
    def ext(self):
        """Gets the ext of this EdFiGraduationPlan.  # noqa: E501


        :return: The ext of this EdFiGraduationPlan.  # noqa: E501
        :rtype: GraduationPlanExtensions
        """
        return self._ext

    @ext.setter
    def ext(self, ext):
        """Sets the ext of this EdFiGraduationPlan.


        :param ext: The ext of this EdFiGraduationPlan.  # noqa: E501
        :type: GraduationPlanExtensions
        """
