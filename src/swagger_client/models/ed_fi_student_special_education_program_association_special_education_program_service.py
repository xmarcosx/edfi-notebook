...
class EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService(object):
    ...
    def __init__(self, special_education_program_service_descriptor=None, primary_indicator=None, service_begin_date=None, service_end_date=None, providers=None):  # noqa: E501
    ...
    def special_education_program_service_descriptor(self, special_education_program_service_descriptor):
        ...
        :type: str
        """
        if special_education_program_service_descriptor is None:
            raise ValueError("Invalid value for `special_education_program_service_descriptor`, must not be `None`")  # noqa: E501
        if special_education_program_service_descriptor is not None and len(special_education_program_service_descriptor) > 306:
