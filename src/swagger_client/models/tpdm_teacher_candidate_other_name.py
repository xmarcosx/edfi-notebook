...
class TpdmTeacherCandidateOtherName(object):
    ...
    def __init__(self, other_name_type_descriptor=None, first_name=None, generation_code_suffix=None, last_surname=None, middle_name=None, personal_title_prefix=None):  # noqa: E501
        """TpdmTeacherCandidateOtherName - a model defined in Swagger"""  # noqa: E501
    ...
    def other_name_type_descriptor(self):
        """Gets the other_name_type_descriptor of this TpdmTeacherCandidateOtherName.  # noqa: E501

        The types of alternate names for a person.  # noqa: E501

        :return: The other_name_type_descriptor of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :rtype: str
        """
    ...
    def other_name_type_descriptor(self, other_name_type_descriptor):
        """Sets the other_name_type_descriptor of this TpdmTeacherCandidateOtherName.

        The types of alternate names for a person.  # noqa: E501

        :param other_name_type_descriptor: The other_name_type_descriptor of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :type: str
        """
        if other_name_type_descriptor is None:
            raise ValueError("Invalid value for `other_name_type_descriptor`, must not be `None`")  # noqa: E501
        if other_name_type_descriptor is not None and len(other_name_type_descriptor) > 306:
    ...
    @property
    def first_name(self):
        """Gets the first_name of this TpdmTeacherCandidateOtherName.  # noqa: E501

        A name given to an individual at birth, baptism, or during another naming ceremony, or through legal change.  # noqa: E501

        :return: The first_name of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this TpdmTeacherCandidateOtherName.

        A name given to an individual at birth, baptism, or during another naming ceremony, or through legal change.  # noqa: E501

        :param first_name: The first_name of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :type: str
        """
    ...
    def generation_code_suffix(self):
        """Gets the generation_code_suffix of this TpdmTeacherCandidateOtherName.  # noqa: E501

        An appendage, if any, used to denote an individual's generation in his family (e.g., Jr., Sr., III).  # noqa: E501

        :return: The generation_code_suffix of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :rtype: str
        """
    ...
    def generation_code_suffix(self, generation_code_suffix):
        """Sets the generation_code_suffix of this TpdmTeacherCandidateOtherName.

        An appendage, if any, used to denote an individual's generation in his family (e.g., Jr., Sr., III).  # noqa: E501

        :param generation_code_suffix: The generation_code_suffix of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :type: str
        """
    ...
    def last_surname(self):
        """Gets the last_surname of this TpdmTeacherCandidateOtherName.  # noqa: E501

        The name borne in common by members of a family.  # noqa: E501

        :return: The last_surname of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :rtype: str
        """
    ...
    def last_surname(self, last_surname):
        """Sets the last_surname of this TpdmTeacherCandidateOtherName.

        The name borne in common by members of a family.  # noqa: E501

        :param last_surname: The last_surname of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :type: str
        """
    ...
    def middle_name(self):
        """Gets the middle_name of this TpdmTeacherCandidateOtherName.  # noqa: E501

        A secondary name given to an individual at birth, baptism, or during another naming ceremony.  # noqa: E501

        :return: The middle_name of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :rtype: str
        """
    ...
    def middle_name(self, middle_name):
        """Sets the middle_name of this TpdmTeacherCandidateOtherName.

        A secondary name given to an individual at birth, baptism, or during another naming ceremony.  # noqa: E501

        :param middle_name: The middle_name of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :type: str
        """
    ...
    def personal_title_prefix(self):
        """Gets the personal_title_prefix of this TpdmTeacherCandidateOtherName.  # noqa: E501

        A prefix used to denote the title, degree, position, or seniority of the person.  # noqa: E501

        :return: The personal_title_prefix of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :rtype: str
        """
    ...
    def personal_title_prefix(self, personal_title_prefix):
        """Sets the personal_title_prefix of this TpdmTeacherCandidateOtherName.

        A prefix used to denote the title, degree, position, or seniority of the person.  # noqa: E501

        :param personal_title_prefix: The personal_title_prefix of this TpdmTeacherCandidateOtherName.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmTeacherCandidateOtherName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmTeacherCandidateOtherName):
            return False
