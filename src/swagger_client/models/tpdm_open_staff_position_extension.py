...
class TpdmOpenStaffPositionExtension(object):
    ...
    def __init__(self, funding_source_descriptor=None, open_staff_position_reason_descriptor=None, term_descriptor=None, full_time_equivalency=None, high_need_academic_subject=None, is_active=None, max_salary=None, min_salary=None, position_control_number=None, total_budgeted=None, school_year_type_reference=None):  # noqa: E501
    ...
    def funding_source_descriptor(self, funding_source_descriptor):
        ...
        :type: str
        """
        if funding_source_descriptor is not None and len(funding_source_descriptor) > 306:
    ...
    def open_staff_position_reason_descriptor(self, open_staff_position_reason_descriptor):
        ...
        :type: str
        """
        if open_staff_position_reason_descriptor is not None and len(open_staff_position_reason_descriptor) > 306:
    ...
    def position_control_number(self, position_control_number):
        ...
        :type: str
        """
        if position_control_number is not None and len(position_control_number) > 20:
