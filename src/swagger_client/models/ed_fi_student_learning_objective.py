...
class EdFiStudentLearningObjective(object):
    ...
    def __init__(self, id=None, grading_period_reference=None, learning_objective_reference=None, student_reference=None, competency_level_descriptor=None, diagnostic_statement=None, general_student_program_associations=None, student_section_associations=None, etag=None):  # noqa: E501
