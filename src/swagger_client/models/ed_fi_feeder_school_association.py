...
class EdFiFeederSchoolAssociation(object):
    ...
    def __init__(self, id=None, begin_date=None, feeder_school_reference=None, school_reference=None, end_date=None, feeder_relationship_description=None, etag=None):  # noqa: E501
    ...
    def feeder_school_reference(self, feeder_school_reference):
        ...
        """
        if feeder_school_reference is None:
    ...
    def feeder_relationship_description(self, feeder_relationship_description):
        ...
        :type: str
        """
        if feeder_relationship_description is not None and len(feeder_relationship_description) > 1024:
