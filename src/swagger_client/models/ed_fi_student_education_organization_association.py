...
class EdFiStudentEducationOrganizationAssociation(object):
    ...
    def __init__(self, id=None, education_organization_reference=None, student_reference=None, addresses=None, cohort_years=None, disabilities=None, electronic_mails=None, hispanic_latino_ethnicity=None, international_addresses=None, languages=None, limited_english_proficiency_descriptor=None, login_id=None, old_ethnicity_descriptor=None, profile_thumbnail=None, program_participations=None, races=None, sex_descriptor=None, student_characteristics=None, student_identification_codes=None, student_indicators=None, telephones=None, tribal_affiliations=None, etag=None):  # noqa: E501
    ...
    def student_characteristics(self):
        ...
        An unordered collection of studentEducationOrganizationAssociationStudentCharacteristics. Reflects important characteristics of the student's home situation:         Displaced Homemaker, Immigrant, Migratory, Military Parent, Pregnant Teen, Single Parent, and Unaccompanied Youth.  # noqa: E501
    ...
    def student_indicators(self):
        ...
        An unordered collection of studentEducationOrganizationAssociationStudentIndicators. Indicator(s) or metric(s) computed for the student (e.g., at risk) to influence more effective education or direct specific interventions.  # noqa: E501
