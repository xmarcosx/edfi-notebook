...
class EdFiEducationContent(object):
    ...
    def content_class_descriptor(self, content_class_descriptor):
        ...
        :type: str
        """
        if content_class_descriptor is not None and len(content_class_descriptor) > 306:
    ...
    def cost_rate_descriptor(self, cost_rate_descriptor):
        ...
        :type: str
        """
        if cost_rate_descriptor is not None and len(cost_rate_descriptor) > 306:
    ...
    def interactivity_style_descriptor(self, interactivity_style_descriptor):
        ...
        :type: str
        """
        if interactivity_style_descriptor is not None and len(interactivity_style_descriptor) > 306:
    ...
    def publisher(self, publisher):
        ...
        :type: str
        """
        if publisher is not None and len(publisher) > 50:
    ...
    def short_description(self, short_description):
        ...
        :type: str
        """
        if short_description is not None and len(short_description) > 75:
    ...
    def time_required(self, time_required):
        ...
        :type: str
        """
        if time_required is not None and len(time_required) > 30:
    ...
    def use_rights_url(self, use_rights_url):
        ...
        :type: str
        """
        if use_rights_url is not None and len(use_rights_url) > 255:
