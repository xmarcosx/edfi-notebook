...
class EdFiStudentInterventionAssociationInterventionEffectiveness(object):
    ...
    def __init__(self, diagnosis_descriptor=None, grade_level_descriptor=None, population_served_descriptor=None, intervention_effectiveness_rating_descriptor=None, improvement_index=None):  # noqa: E501
        """EdFiStudentInterventionAssociationInterventionEffectiveness - a model defined in Swagger"""  # noqa: E501
    ...
    def diagnosis_descriptor(self):
        """Gets the diagnosis_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501

        Targeted purpose of the intervention (e.g., attendance issue, dropout risk) for which the effectiveness is measured.  # noqa: E501

        :return: The diagnosis_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :rtype: str
        """
    ...
    def diagnosis_descriptor(self, diagnosis_descriptor):
        """Sets the diagnosis_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.

        Targeted purpose of the intervention (e.g., attendance issue, dropout risk) for which the effectiveness is measured.  # noqa: E501

        :param diagnosis_descriptor: The diagnosis_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :type: str
        """
        if diagnosis_descriptor is None:
            raise ValueError("Invalid value for `diagnosis_descriptor`, must not be `None`")  # noqa: E501
        if diagnosis_descriptor is not None and len(diagnosis_descriptor) > 306:
    ...
    def grade_level_descriptor(self):
        """Gets the grade_level_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501

        Grade level for which effectiveness is measured.  # noqa: E501

        :return: The grade_level_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :rtype: str
        """
    ...
    def grade_level_descriptor(self, grade_level_descriptor):
        """Sets the grade_level_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.

        Grade level for which effectiveness is measured.  # noqa: E501

        :param grade_level_descriptor: The grade_level_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :type: str
        """
    ...
    def population_served_descriptor(self):
        """Gets the population_served_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501

        Population for which effectiveness is measured.  # noqa: E501

        :return: The population_served_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :rtype: str
        """
    ...
    def population_served_descriptor(self, population_served_descriptor):
        """Sets the population_served_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.

        Population for which effectiveness is measured.  # noqa: E501

        :param population_served_descriptor: The population_served_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :type: str
        """
        if population_served_descriptor is None:
            raise ValueError("Invalid value for `population_served_descriptor`, must not be `None`")  # noqa: E501
        if population_served_descriptor is not None and len(population_served_descriptor) > 306:
    ...
    def intervention_effectiveness_rating_descriptor(self):
        """Gets the intervention_effectiveness_rating_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        ...
        :return: The intervention_effectiveness_rating_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :rtype: str
        """
    ...
    def intervention_effectiveness_rating_descriptor(self, intervention_effectiveness_rating_descriptor):
        """Sets the intervention_effectiveness_rating_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.

        An intervention demonstrates effectiveness if the research has shown that the program caused an improvement in outcomes. Values: positive effects, potentially positive effects, mixed effects, potentially negative effects, negative effects, and no discernible effects.  # noqa: E501

        :param intervention_effectiveness_rating_descriptor: The intervention_effectiveness_rating_descriptor of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :type: str
        """
        if intervention_effectiveness_rating_descriptor is None:
            raise ValueError("Invalid value for `intervention_effectiveness_rating_descriptor`, must not be `None`")  # noqa: E501
        if intervention_effectiveness_rating_descriptor is not None and len(intervention_effectiveness_rating_descriptor) > 306:
    ...
    def improvement_index(self):
        """Gets the improvement_index of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        ...
        :return: The improvement_index of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :rtype: int
        """
    ...
    def improvement_index(self, improvement_index):
        """Sets the improvement_index of this EdFiStudentInterventionAssociationInterventionEffectiveness.

        Along a percentile distribution of students, the improvement index represents the change in an average student's percentile rank that is considered to be due to the intervention.  # noqa: E501

        :param improvement_index: The improvement_index of this EdFiStudentInterventionAssociationInterventionEffectiveness.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EdFiStudentInterventionAssociationInterventionEffectiveness, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdFiStudentInterventionAssociationInterventionEffectiveness):
            return False
