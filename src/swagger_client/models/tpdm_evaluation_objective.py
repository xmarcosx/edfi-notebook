...
class TpdmEvaluationObjective(object):
    ...
    def __init__(self, id=None, evaluation_objective_title=None, evaluation_reference=None, evaluation_type_descriptor=None, max_rating=None, min_rating=None, rating_levels=None, sort_order=None, etag=None):  # noqa: E501
