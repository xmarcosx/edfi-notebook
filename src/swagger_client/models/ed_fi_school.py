...
class EdFiSchool(object):
    ...
    def education_organization_categories(self, education_organization_categories):
        ...
        """
        if education_organization_categories is None:
    ...
    def charter_approval_agency_type_descriptor(self, charter_approval_agency_type_descriptor):
        ...
        :type: str
        """
        if charter_approval_agency_type_descriptor is not None and len(charter_approval_agency_type_descriptor) > 306:
    ...
    def internet_access_descriptor(self, internet_access_descriptor):
        ...
        :type: str
        """
        if internet_access_descriptor is not None and len(internet_access_descriptor) > 306:
    ...
    def magnet_special_program_emphasis_school_descriptor(self, magnet_special_program_emphasis_school_descriptor):
        ...
        :type: str
        """
        if magnet_special_program_emphasis_school_descriptor is not None and len(magnet_special_program_emphasis_school_descriptor) > 306:
    ...
    def school_type_descriptor(self, school_type_descriptor):
        ...
        :type: str
        """
        if school_type_descriptor is not None and len(school_type_descriptor) > 306:
    ...
    def title_i_part_a_school_designation_descriptor(self, title_i_part_a_school_designation_descriptor):
        ...
        :type: str
        """
        if title_i_part_a_school_designation_descriptor is not None and len(title_i_part_a_school_designation_descriptor) > 306:
