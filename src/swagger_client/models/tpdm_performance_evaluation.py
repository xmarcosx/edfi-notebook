...
class TpdmPerformanceEvaluation(object):
    ...
    swagger_types = {
        ...
        'program_gateways': 'list[TpdmPerformanceEvaluationProgramGateway]',
    ...
    attribute_map = {
        ...
        'program_gateways': 'programGateways',
        'rating_levels': 'ratingLevels',
        'etag': '_etag'
    }

    def __init__(self, id=None, evaluation_period_descriptor=None, performance_evaluation_title=None, performance_evaluation_type_descriptor=None, term_descriptor=None, education_organization_reference=None, school_year_type_reference=None, academic_subject_descriptor=None, grade_levels=None, program_gateways=None, rating_levels=None, etag=None):  # noqa: E501
        ...
        if program_gateways is not None:
            self.program_gateways = program_gateways
    ...
    def academic_subject_descriptor(self):
        ...
        The description of the content or subject area (e.g., arts, mathematics, reading, stenography, or a foreign language) of a performance evaluation.  # noqa: E501
    ...
    @property
    def program_gateways(self):
        """Gets the program_gateways of this TpdmPerformanceEvaluation.  # noqa: E501

        An unordered collection of performanceEvaluationProgramGateways. Identifies the program gateway that may be associated for continuation in the program.  # noqa: E501

        :return: The program_gateways of this TpdmPerformanceEvaluation.  # noqa: E501
        :rtype: list[TpdmPerformanceEvaluationProgramGateway]
        """
        return self._program_gateways

    @program_gateways.setter
    def program_gateways(self, program_gateways):
        """Sets the program_gateways of this TpdmPerformanceEvaluation.

        An unordered collection of performanceEvaluationProgramGateways. Identifies the program gateway that may be associated for continuation in the program.  # noqa: E501

        :param program_gateways: The program_gateways of this TpdmPerformanceEvaluation.  # noqa: E501
        :type: list[TpdmPerformanceEvaluationProgramGateway]
        """

        self._program_gateways = program_gateways
