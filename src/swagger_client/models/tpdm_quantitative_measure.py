...
class TpdmQuantitativeMeasure(object):
    ...
    def __init__(self, id=None, quantitative_measure_identifier=None, evaluation_element_reference=None, quantitative_measure_datatype_descriptor=None, quantitative_measure_type_descriptor=None, etag=None):  # noqa: E501
    ...
    def quantitative_measure_datatype_descriptor(self, quantitative_measure_datatype_descriptor):
        ...
        :type: str
        """
        if quantitative_measure_datatype_descriptor is not None and len(quantitative_measure_datatype_descriptor) > 306:
    ...
    def quantitative_measure_type_descriptor(self, quantitative_measure_type_descriptor):
        ...
        :type: str
        """
        if quantitative_measure_type_descriptor is not None and len(quantitative_measure_type_descriptor) > 306:
