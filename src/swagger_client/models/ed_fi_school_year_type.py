...
class EdFiSchoolYearType(object):
    ...
    def __init__(self, id=None, school_year=None, current_school_year=None, school_year_description=None, etag=None):  # noqa: E501
    ...
    def school_year_description(self, school_year_description):
        ...
        :type: str
        """
        if school_year_description is None:
            raise ValueError("Invalid value for `school_year_description`, must not be `None`")  # noqa: E501
        if school_year_description is not None and len(school_year_description) > 50:
