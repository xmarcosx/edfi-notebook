...
class EdFiGradeLearningStandardGrade(object):
    ...
    def __init__(self, performance_base_conversion_descriptor=None, diagnostic_statement=None, letter_grade_earned=None, numeric_grade_earned=None, learning_standard_reference=None):  # noqa: E501
    ...
    def performance_base_conversion_descriptor(self, performance_base_conversion_descriptor):
        ...
        :type: str
        """
        if performance_base_conversion_descriptor is not None and len(performance_base_conversion_descriptor) > 306:
