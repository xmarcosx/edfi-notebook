...
class EdFiGradebookEntry(object):
    ...
    def __init__(self, id=None, date_assigned=None, gradebook_entry_title=None, grading_period_reference=None, section_reference=None, description=None, due_date=None, gradebook_entry_type_descriptor=None, learning_objectives=None, learning_standards=None, etag=None):  # noqa: E501
    ...
    def gradebook_entry_type_descriptor(self, gradebook_entry_type_descriptor):
        ...
        :type: str
        """
        if gradebook_entry_type_descriptor is not None and len(gradebook_entry_type_descriptor) > 306:
