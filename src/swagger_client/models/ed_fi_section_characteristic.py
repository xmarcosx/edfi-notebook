...
class EdFiSectionCharacteristic(object):
    ...
    def __init__(self, section_characteristic_descriptor=None):  # noqa: E501
    ...
    def section_characteristic_descriptor(self, section_characteristic_descriptor):
        ...
        :type: str
        """
        if section_characteristic_descriptor is None:
            raise ValueError("Invalid value for `section_characteristic_descriptor`, must not be `None`")  # noqa: E501
        if section_characteristic_descriptor is not None and len(section_characteristic_descriptor) > 306:
