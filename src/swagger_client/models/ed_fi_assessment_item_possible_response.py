...
class EdFiAssessmentItemPossibleResponse(object):
    ...
    def __init__(self, response_value=None, correct_response=None, response_description=None):  # noqa: E501
    ...
    def response_value(self, response_value):
        ...
        if response_value is not None and len(response_value) > 60:
    ...
    def response_description(self, response_description):
        ...
        :type: str
        """
        if response_description is not None and len(response_description) > 1024:
