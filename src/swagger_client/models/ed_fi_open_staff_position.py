...
class EdFiOpenStaffPosition(object):
    ...
    swagger_types = {
        ...
        'etag': 'str',
        'ext': 'OpenStaffPositionExtensions'
    }
    ...
    def __init__(self, id=None, requisition_number=None, education_organization_reference=None, academic_subjects=None, date_posted=None, date_posting_removed=None, employment_status_descriptor=None, instructional_grade_levels=None, position_title=None, posting_result_descriptor=None, program_assignment_descriptor=None, staff_classification_descriptor=None, etag=None, ext=None):  # noqa: E501
    ...
    def posting_result_descriptor(self, posting_result_descriptor):
        ...
        :type: str
        """
        if posting_result_descriptor is not None and len(posting_result_descriptor) > 306:
    ...
    def staff_classification_descriptor(self, staff_classification_descriptor):
        ...
        :type: str
        """
        if staff_classification_descriptor is None:
            raise ValueError("Invalid value for `staff_classification_descriptor`, must not be `None`")  # noqa: E501
        if staff_classification_descriptor is not None and len(staff_classification_descriptor) > 306:
    ...
    @property
    def ext(self):
        """Gets the ext of this EdFiOpenStaffPosition.  # noqa: E501


        :return: The ext of this EdFiOpenStaffPosition.  # noqa: E501
        :rtype: OpenStaffPositionExtensions
        """
        return self._ext

    @ext.setter
    def ext(self, ext):
        """Sets the ext of this EdFiOpenStaffPosition.


        :param ext: The ext of this EdFiOpenStaffPosition.  # noqa: E501
        :type: OpenStaffPositionExtensions
        """
