...
class TpdmEvaluationRating(object):
    ...
    def __init__(self, id=None, evaluation_date=None, evaluation_reference=None, performance_evaluation_rating_reference=None, section_reference=None, evaluation_rating_level_descriptor=None, results=None, reviewers=None, etag=None):  # noqa: E501
    ...
    def performance_evaluation_rating_reference(self, performance_evaluation_rating_reference):
        ...
        """
        if performance_evaluation_rating_reference is None:
