...
class EdFiDisciplineIncident(object):
    ...
    def case_number(self, case_number):
        ...
        :type: str
        """
        if case_number is not None and len(case_number) > 20:
    ...
    def incident_description(self, incident_description):
        ...
        :type: str
        """
        if incident_description is not None and len(incident_description) > 1024:
    ...
    def incident_location_descriptor(self, incident_location_descriptor):
        ...
        :type: str
        """
        if incident_location_descriptor is not None and len(incident_location_descriptor) > 306:
    ...
    def reporter_description_descriptor(self, reporter_description_descriptor):
        ...
        :type: str
        """
        if reporter_description_descriptor is not None and len(reporter_description_descriptor) > 306:
    ...
    def reporter_name(self, reporter_name):
        ...
        :type: str
        """
        if reporter_name is not None and len(reporter_name) > 75:
