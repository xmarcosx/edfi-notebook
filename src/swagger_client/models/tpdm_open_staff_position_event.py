...
class TpdmOpenStaffPositionEvent(object):
    ...
    def __init__(self, id=None, event_date=None, open_staff_position_event_type_descriptor=None, open_staff_position_reference=None, open_staff_position_event_status_descriptor=None, etag=None):  # noqa: E501
    ...
    def open_staff_position_event_type_descriptor(self, open_staff_position_event_type_descriptor):
        ...
        :type: str
        """
        if open_staff_position_event_type_descriptor is None:
            raise ValueError("Invalid value for `open_staff_position_event_type_descriptor`, must not be `None`")  # noqa: E501
        if open_staff_position_event_type_descriptor is not None and len(open_staff_position_event_type_descriptor) > 306:
    ...
    def open_staff_position_event_status_descriptor(self, open_staff_position_event_status_descriptor):
        ...
        :type: str
        """
        if open_staff_position_event_status_descriptor is not None and len(open_staff_position_event_status_descriptor) > 306:
