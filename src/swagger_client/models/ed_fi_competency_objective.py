...
class EdFiCompetencyObjective(object):
    ...
    def __init__(self, id=None, objective=None, objective_grade_level_descriptor=None, education_organization_reference=None, competency_objective_id=None, description=None, success_criteria=None, etag=None):  # noqa: E501
    ...
    def competency_objective_id(self, competency_objective_id):
        ...
        :type: str
        """
        if competency_objective_id is not None and len(competency_objective_id) > 60:
