...
class EdFiCourse(object):
    ...
    def course_defined_by_descriptor(self, course_defined_by_descriptor):
        ...
        :type: str
        """
        if course_defined_by_descriptor is not None and len(course_defined_by_descriptor) > 306:
    ...
    def course_description(self, course_description):
        ...
        :type: str
        """
        if course_description is not None and len(course_description) > 1024:
    ...
    def course_gpa_applicability_descriptor(self, course_gpa_applicability_descriptor):
        ...
        :type: str
        """
        if course_gpa_applicability_descriptor is not None and len(course_gpa_applicability_descriptor) > 306:
    ...
    def maximum_available_credit_type_descriptor(self, maximum_available_credit_type_descriptor):
        ...
        :type: str
        """
        if maximum_available_credit_type_descriptor is not None and len(maximum_available_credit_type_descriptor) > 306:
    ...
    def minimum_available_credit_type_descriptor(self, minimum_available_credit_type_descriptor):
        ...
        :type: str
        """
        if minimum_available_credit_type_descriptor is not None and len(minimum_available_credit_type_descriptor) > 306:
