...
class EdFiGraduationPlanCreditsBySubject(object):
    ...
    def __init__(self, academic_subject_descriptor=None, credit_type_descriptor=None, credit_conversion=None, credits=None):  # noqa: E501
    ...
    def credit_type_descriptor(self, credit_type_descriptor):
        ...
        :type: str
        """
        if credit_type_descriptor is not None and len(credit_type_descriptor) > 306:
