...
class EdFiSurveyQuestion(object):
    ...
    def __init__(self, id=None, question_code=None, survey_reference=None, survey_section_reference=None, matrices=None, question_form_descriptor=None, question_text=None, response_choices=None, etag=None):  # noqa: E501
    ...
    def question_form_descriptor(self, question_form_descriptor):
        ...
        :type: str
        """
        if question_form_descriptor is None:
            raise ValueError("Invalid value for `question_form_descriptor`, must not be `None`")  # noqa: E501
        if question_form_descriptor is not None and len(question_form_descriptor) > 306:
    ...
    def question_text(self, question_text):
        ...
        if question_text is not None and len(question_text) > 1024:
