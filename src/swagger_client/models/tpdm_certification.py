...
class TpdmCertification(object):
    ...
    def certification_field_descriptor(self, certification_field_descriptor):
        ...
        :type: str
        """
        if certification_field_descriptor is not None and len(certification_field_descriptor) > 306:
    ...
    def certification_level_descriptor(self, certification_level_descriptor):
        ...
        :type: str
        """
        if certification_level_descriptor is not None and len(certification_level_descriptor) > 306:
    ...
    def certification_standard_descriptor(self, certification_standard_descriptor):
        ...
        :type: str
        """
        if certification_standard_descriptor is not None and len(certification_standard_descriptor) > 306:
    ...
    def educator_role_descriptor(self, educator_role_descriptor):
        ...
        :type: str
        """
        if educator_role_descriptor is not None and len(educator_role_descriptor) > 306:
    ...
    def instructional_setting_descriptor(self, instructional_setting_descriptor):
        ...
        :type: str
        """
        if instructional_setting_descriptor is not None and len(instructional_setting_descriptor) > 306:
    ...
    def minimum_degree_descriptor(self, minimum_degree_descriptor):
        ...
        :type: str
        """
        if minimum_degree_descriptor is not None and len(minimum_degree_descriptor) > 306:
