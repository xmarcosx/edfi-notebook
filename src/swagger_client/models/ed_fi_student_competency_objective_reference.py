...
class EdFiStudentCompetencyObjectiveReference(object):
    ...
    def __init__(self, grading_period_descriptor=None, grading_period_school_id=None, grading_period_school_year=None, grading_period_sequence=None, objective=None, objective_education_organization_id=None, objective_grade_level_descriptor=None, student_unique_id=None, link=None):  # noqa: E501
    ...
    def objective_education_organization_id(self, objective_education_organization_id):
        ...
        :type: int
        """
        if objective_education_organization_id is None:
