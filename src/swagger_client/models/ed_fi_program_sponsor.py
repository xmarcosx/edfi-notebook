...
class EdFiProgramSponsor(object):
    ...
    def __init__(self, program_sponsor_descriptor=None):  # noqa: E501
    ...
    def program_sponsor_descriptor(self, program_sponsor_descriptor):
        ...
        :type: str
        """
        if program_sponsor_descriptor is None:
            raise ValueError("Invalid value for `program_sponsor_descriptor`, must not be `None`")  # noqa: E501
        if program_sponsor_descriptor is not None and len(program_sponsor_descriptor) > 306:
