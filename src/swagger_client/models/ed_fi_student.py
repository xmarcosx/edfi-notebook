...
class EdFiStudent(object):
    ...
    def __init__(self, id=None, student_unique_id=None, person_reference=None, birth_city=None, birth_country_descriptor=None, birth_date=None, birth_international_province=None, birth_sex_descriptor=None, birth_state_abbreviation_descriptor=None, citizenship_status_descriptor=None, date_entered_us=None, first_name=None, generation_code_suffix=None, identification_documents=None, last_surname=None, maiden_name=None, middle_name=None, multiple_birth_status=None, other_names=None, personal_identification_documents=None, personal_title_prefix=None, visas=None, etag=None):  # noqa: E501
