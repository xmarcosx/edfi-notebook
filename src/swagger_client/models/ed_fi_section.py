...
class EdFiSection(object):
    ...
    def course_offering_reference(self, course_offering_reference):
        ...
        """
        if course_offering_reference is None:
    ...
    def available_credit_type_descriptor(self, available_credit_type_descriptor):
        ...
        :type: str
        """
        if available_credit_type_descriptor is not None and len(available_credit_type_descriptor) > 306:
    ...
    def educational_environment_descriptor(self, educational_environment_descriptor):
        ...
        :type: str
        """
        if educational_environment_descriptor is not None and len(educational_environment_descriptor) > 306:
    ...
    def instruction_language_descriptor(self, instruction_language_descriptor):
        ...
        :type: str
        """
        if instruction_language_descriptor is not None and len(instruction_language_descriptor) > 306:
    ...
    def medium_of_instruction_descriptor(self, medium_of_instruction_descriptor):
        ...
        :type: str
        """
        if medium_of_instruction_descriptor is not None and len(medium_of_instruction_descriptor) > 306:
