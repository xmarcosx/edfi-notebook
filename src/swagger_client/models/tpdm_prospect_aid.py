...
class TpdmProspectAid(object):
    ...
    def __init__(self, aid_type_descriptor=None, aid_amount=None, aid_condition_description=None, begin_date=None, end_date=None, pell_grant_recipient=None):  # noqa: E501
        """TpdmProspectAid - a model defined in Swagger"""  # noqa: E501
    ...
    def aid_type_descriptor(self):
        """Gets the aid_type_descriptor of this TpdmProspectAid.  # noqa: E501

        The classification of financial aid awarded to a person for the academic term/year.  # noqa: E501

        :return: The aid_type_descriptor of this TpdmProspectAid.  # noqa: E501
        :rtype: str
        """
    ...
    def aid_type_descriptor(self, aid_type_descriptor):
        """Sets the aid_type_descriptor of this TpdmProspectAid.

        The classification of financial aid awarded to a person for the academic term/year.  # noqa: E501

        :param aid_type_descriptor: The aid_type_descriptor of this TpdmProspectAid.  # noqa: E501
        :type: str
        """
    ...
    @property
    def aid_amount(self):
        """Gets the aid_amount of this TpdmProspectAid.  # noqa: E501

        The amount of financial aid awarded to a person for the term/year.  # noqa: E501

        :return: The aid_amount of this TpdmProspectAid.  # noqa: E501
        :rtype: float
        """
    ...
    def aid_amount(self, aid_amount):
        """Sets the aid_amount of this TpdmProspectAid.

        The amount of financial aid awarded to a person for the term/year.  # noqa: E501

        :param aid_amount: The aid_amount of this TpdmProspectAid.  # noqa: E501
        :type: float
        """
    ...
    def aid_condition_description(self):
        """Gets the aid_condition_description of this TpdmProspectAid.  # noqa: E501

        The description of the condition (e.g., placement in a high need school) under which the aid was given.  # noqa: E501

        :return: The aid_condition_description of this TpdmProspectAid.  # noqa: E501
        :rtype: str
        """
    ...
    def aid_condition_description(self, aid_condition_description):
        """Sets the aid_condition_description of this TpdmProspectAid.

        The description of the condition (e.g., placement in a high need school) under which the aid was given.  # noqa: E501

        :param aid_condition_description: The aid_condition_description of this TpdmProspectAid.  # noqa: E501
        :type: str
        """
    ...
    @property
    def begin_date(self):
        """Gets the begin_date of this TpdmProspectAid.  # noqa: E501

        The date the award was designated.  # noqa: E501

        :return: The begin_date of this TpdmProspectAid.  # noqa: E501
        :rtype: date
        """
    ...
    def begin_date(self, begin_date):
        """Sets the begin_date of this TpdmProspectAid.

        The date the award was designated.  # noqa: E501

        :param begin_date: The begin_date of this TpdmProspectAid.  # noqa: E501
        :type: date
        """
    ...
    @property
    def end_date(self):
        """Gets the end_date of this TpdmProspectAid.  # noqa: E501

        The date the award was removed.  # noqa: E501

        :return: The end_date of this TpdmProspectAid.  # noqa: E501
        :rtype: date
        """
    ...
    def end_date(self, end_date):
        """Sets the end_date of this TpdmProspectAid.

        The date the award was removed.  # noqa: E501

        :param end_date: The end_date of this TpdmProspectAid.  # noqa: E501
        :type: date
        """
    ...
    def pell_grant_recipient(self):
        """Gets the pell_grant_recipient of this TpdmProspectAid.  # noqa: E501

        Indicates a person who receives Pell Grant aid.  # noqa: E501

        :return: The pell_grant_recipient of this TpdmProspectAid.  # noqa: E501
        :rtype: bool
        """
    ...
    def pell_grant_recipient(self, pell_grant_recipient):
        """Sets the pell_grant_recipient of this TpdmProspectAid.

        Indicates a person who receives Pell Grant aid.  # noqa: E501

        :param pell_grant_recipient: The pell_grant_recipient of this TpdmProspectAid.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmProspectAid, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmProspectAid):
            return False
