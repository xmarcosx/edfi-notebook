...
class TpdmAnonymizedStudentAssessmentReference(object):
    ...
    def __init__(self, administration_date=None, anonymized_student_identifier=None, assessment_identifier=None, facts_as_of_date=None, school_year=None, taken_school_year=None, link=None):  # noqa: E501
