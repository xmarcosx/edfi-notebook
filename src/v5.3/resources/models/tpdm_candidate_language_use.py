...
class TpdmCandidateLanguageUse(object):
    ...
    def __init__(self, language_use_descriptor=None, _configuration=None):  # noqa: E501
        """TpdmCandidateLanguageUse - a model defined in Swagger"""  # noqa: E501
    ...
    def language_use_descriptor(self):
        """Gets the language_use_descriptor of this TpdmCandidateLanguageUse.  # noqa: E501

        A description of how the language is used (e.g. Home Language, Native Language, Spoken Language).  # noqa: E501

        :return: The language_use_descriptor of this TpdmCandidateLanguageUse.  # noqa: E501
        :rtype: str
        """
    ...
    def language_use_descriptor(self, language_use_descriptor):
        """Sets the language_use_descriptor of this TpdmCandidateLanguageUse.

        A description of how the language is used (e.g. Home Language, Native Language, Spoken Language).  # noqa: E501

        :param language_use_descriptor: The language_use_descriptor of this TpdmCandidateLanguageUse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmCandidateLanguageUse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmCandidateLanguageUse):
            return False
