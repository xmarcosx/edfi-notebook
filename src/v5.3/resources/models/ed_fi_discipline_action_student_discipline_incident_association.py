...
class EdFiDisciplineActionStudentDisciplineIncidentAssociation(object):
    ...
    def __init__(self, student_discipline_incident_association_reference=None, _configuration=None):  # noqa: E501
    ...
    def student_discipline_incident_association_reference(self, student_discipline_incident_association_reference):
        ...
        """
        if self._configuration.client_side_validation and student_discipline_incident_association_reference is None:
