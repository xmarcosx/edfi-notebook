...
class EdFiEducationOrganizationNetwork(object):
    ...
    def network_purpose_descriptor(self, network_purpose_descriptor):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and network_purpose_descriptor is None:
            raise ValueError("Invalid value for `network_purpose_descriptor`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                network_purpose_descriptor is not None and len(network_purpose_descriptor) > 306):
