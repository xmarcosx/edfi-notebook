...
class SessionsApi(object):
    ...
    def get_sessions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'session_name', 'school_id', 'school_year', 'term_descriptor', 'begin_date', 'end_date', 'id', 'total_instructional_days', 'snapshot_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
