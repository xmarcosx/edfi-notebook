...
class ParentsApi(object):
    ...
    def delete_parent_by_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_parent_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_parent_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_parent_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_parent_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes an existing resource using the resource identifier.  # noqa: E501

        The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_parent_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_parent_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `delete_parent_by_id`")  # noqa: E501
    ...
    def deletes_parents(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deletes_parents(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.deletes_parents_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.deletes_parents_with_http_info(**kwargs)  # noqa: E501
            return data

    def deletes_parents_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves deleted resources based on change version.  # noqa: E501

        The DELETES operation is used to retrieve deleted resources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deletes_parents_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deletes_parents" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_parents`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_parents`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_parents(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_parents(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_parents_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_parents_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_parents_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves specific resources using the resource's property values (using the \"Get\" pattern).  # noqa: E501

        This GET operation provides access to resources using the \"Get\" search pattern.  The values of any properties of the resource that are specified will be used to return all matching results (if it exists).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_parents_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'parent_unique_id', 'person_id', 'source_system_descriptor', 'highest_completed_level_of_education_descriptor', 'sex_descriptor', 'first_name', 'generation_code_suffix', 'id', 'last_surname', 'login_id', 'maiden_name', 'middle_name', 'personal_title_prefix', 'snapshot_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_parents`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_parents`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and ('parent_unique_id' in params and
                                                       len(params['parent_unique_id']) > 32):
            raise ValueError("Invalid value for parameter `parent_unique_id` when calling `get_parents`, length must be less than or equal to `32`")  # noqa: E501
        if self.api_client.client_side_validation and ('person_id' in params and
                                                       len(params['person_id']) > 32):
            raise ValueError("Invalid value for parameter `person_id` when calling `get_parents`, length must be less than or equal to `32`")  # noqa: E501
        if self.api_client.client_side_validation and ('source_system_descriptor' in params and
            ...
            raise ValueError("Invalid value for parameter `source_system_descriptor` when calling `get_parents`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('highest_completed_level_of_education_descriptor' in params and
            ...
            raise ValueError("Invalid value for parameter `highest_completed_level_of_education_descriptor` when calling `get_parents`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('sex_descriptor' in params and
                                                       len(params['sex_descriptor']) > 306):
            raise ValueError("Invalid value for parameter `sex_descriptor` when calling `get_parents`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('first_name' in params and
                                                       len(params['first_name']) > 75):
            raise ValueError("Invalid value for parameter `first_name` when calling `get_parents`, length must be less than or equal to `75`")  # noqa: E501
        if self.api_client.client_side_validation and ('generation_code_suffix' in params and
                                                       len(params['generation_code_suffix']) > 10):
            raise ValueError("Invalid value for parameter `generation_code_suffix` when calling `get_parents`, length must be less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and ('last_surname' in params and
                                                       len(params['last_surname']) > 75):
            raise ValueError("Invalid value for parameter `last_surname` when calling `get_parents`, length must be less than or equal to `75`")  # noqa: E501
        if self.api_client.client_side_validation and ('login_id' in params and
                                                       len(params['login_id']) > 60):
            raise ValueError("Invalid value for parameter `login_id` when calling `get_parents`, length must be less than or equal to `60`")  # noqa: E501
        if self.api_client.client_side_validation and ('maiden_name' in params and
                                                       len(params['maiden_name']) > 75):
            raise ValueError("Invalid value for parameter `maiden_name` when calling `get_parents`, length must be less than or equal to `75`")  # noqa: E501
        if self.api_client.client_side_validation and ('middle_name' in params and
                                                       len(params['middle_name']) > 75):
            raise ValueError("Invalid value for parameter `middle_name` when calling `get_parents`, length must be less than or equal to `75`")  # noqa: E501
        if self.api_client.client_side_validation and ('personal_title_prefix' in params and
                                                       len(params['personal_title_prefix']) > 30):
            raise ValueError("Invalid value for parameter `personal_title_prefix` when calling `get_parents`, length must be less than or equal to `30`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[EdFiParent]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_parents_by_id(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_parents_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_parents_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_parents_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_parents_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).  # noqa: E501

        This GET operation retrieves a resource by the specified resource identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_parents_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_parents_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `get_parents_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EdFiParent',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_parent(self, parent, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_parent(parent, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EdFiParent parent: The JSON representation of the \"parent\" resource to be created or updated. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_parent_with_http_info(parent, **kwargs)  # noqa: E501
        else:
            (data) = self.post_parent_with_http_info(parent, **kwargs)  # noqa: E501
            return data

    def post_parent_with_http_info(self, parent, **kwargs):  # noqa: E501
        """Creates or updates resources based on the natural key values of the supplied resource.  # noqa: E501

        The POST operation can be used to create or update resources. In database terms, this is often referred to as an \"upsert\" operation (insert + update). Clients should NOT include the resource \"id\" in the JSON body because it will result in an error. The web service will identify whether the resource already exists based on the natural key values provided, and update or create the resource appropriately. It is recommended to use POST for both create and update except while updating natural key of a resource in which case PUT operation must be used.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_parent_with_http_info(parent, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_parent" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'parent' is set
        if self.api_client.client_side_validation and ('parent' not in params or
                                                       params['parent'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `parent` when calling `post_parent`")  # noqa: E501
    ...
    def put_parent(self, id, parent, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_parent(id, parent, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_parent_with_http_info(id, parent, **kwargs)  # noqa: E501
        else:
            (data) = self.put_parent_with_http_info(id, parent, **kwargs)  # noqa: E501
            return data

    def put_parent_with_http_info(self, id, parent, **kwargs):  # noqa: E501
        """Updates a resource based on the resource identifier.  # noqa: E501

        The PUT operation is used to update a resource by identifier. If the resource identifier (\"id\") is provided in the JSON body, it will be ignored. Additionally, this API resource is not configured for cascading natural key updates. Natural key values for this resource cannot be changed using PUT operation and will not be modified in the database, and so recommendation is to use POST as that supports upsert behavior.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_parent_with_http_info(id, parent, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'parent', 'if_match']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `put_parent`")  # noqa: E501
        # verify the required parameter 'parent' is set
        if self.api_client.client_side_validation and ('parent' not in params or
                                                       params['parent'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `parent` when calling `put_parent`")  # noqa: E501
