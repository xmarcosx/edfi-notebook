...
class InterventionsApi(object):
    ...
    def get_interventions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'intervention_identification_code', 'education_organization_id', 'delivery_method_descriptor', 'intervention_class_descriptor', 'begin_date', 'end_date', 'id', 'max_dosage', 'min_dosage', 'snapshot_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_intervention_with_http_info(self, intervention, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('intervention' not in params or
                                                       params['intervention'] is None):  # noqa: E501
