...
class StudentSectionAttendanceEventsApi(object):
    ...
    def delete_student_section_attendance_event_by_id(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.delete_student_section_attendance_event_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_student_section_attendance_event_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_student_section_attendance_event_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes an existing resource using the resource identifier.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_student_section_attendance_event_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `delete_student_section_attendance_event_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ed-fi/studentSectionAttendanceEvents/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def deletes_student_section_attendance_events(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.deletes_student_section_attendance_events_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.deletes_student_section_attendance_events_with_http_info(**kwargs)  # noqa: E501
            return data

    def deletes_student_section_attendance_events_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves deleted resources based on change version.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deletes_student_section_attendance_events" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_student_section_attendance_events`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_student_section_attendance_events`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/ed-fi/studentSectionAttendanceEvents/deletes', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_student_section_attendance_events(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_student_section_attendance_events_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_student_section_attendance_events_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_student_section_attendance_events_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves specific resources using the resource's property values (using the \"Get\" pattern).  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_student_section_attendance_events" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_student_section_attendance_events`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_student_section_attendance_events`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and ('attendance_event_category_descriptor' in params and
            ...
            raise ValueError("Invalid value for parameter `attendance_event_category_descriptor` when calling `get_student_section_attendance_events`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('local_course_code' in params and
                                                       len(params['local_course_code']) > 60):
            raise ValueError("Invalid value for parameter `local_course_code` when calling `get_student_section_attendance_events`, length must be less than or equal to `60`")  # noqa: E501
        if self.api_client.client_side_validation and ('section_identifier' in params and
                                                       len(params['section_identifier']) > 255):
            raise ValueError("Invalid value for parameter `section_identifier` when calling `get_student_section_attendance_events`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('session_name' in params and
                                                       len(params['session_name']) > 60):
            raise ValueError("Invalid value for parameter `session_name` when calling `get_student_section_attendance_events`, length must be less than or equal to `60`")  # noqa: E501
        if self.api_client.client_side_validation and ('student_unique_id' in params and
                                                       len(params['student_unique_id']) > 32):
            raise ValueError("Invalid value for parameter `student_unique_id` when calling `get_student_section_attendance_events`, length must be less than or equal to `32`")  # noqa: E501
        if self.api_client.client_side_validation and ('educational_environment_descriptor' in params and
            ...
            raise ValueError("Invalid value for parameter `educational_environment_descriptor` when calling `get_student_section_attendance_events`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('attendance_event_reason' in params and
            ...
            raise ValueError("Invalid value for parameter `attendance_event_reason` when calling `get_student_section_attendance_events`, length must be less than or equal to `255`")  # noqa: E501
        collection_formats = {}
        ...
        if 'section_attendance_duration' in params:
            query_params.append(('sectionAttendanceDuration', params['section_attendance_duration']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ed-fi/studentSectionAttendanceEvents', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[EdFiStudentSectionAttendanceEvent]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_student_section_attendance_events_by_id(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_student_section_attendance_events_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_student_section_attendance_events_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_student_section_attendance_events_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_student_section_attendance_events_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `get_student_section_attendance_events_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ed-fi/studentSectionAttendanceEvents/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='EdFiStudentSectionAttendanceEvent',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_student_section_attendance_event(self, student_section_attendance_event, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_student_section_attendance_event_with_http_info(student_section_attendance_event, **kwargs)  # noqa: E501
        else:
            (data) = self.post_student_section_attendance_event_with_http_info(student_section_attendance_event, **kwargs)  # noqa: E501
            return data

    def post_student_section_attendance_event_with_http_info(self, student_section_attendance_event, **kwargs):  # noqa: E501
        """Creates or updates resources based on the natural key values of the supplied resource.  # noqa: E501
        ...
        all_params = ['student_section_attendance_event']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_student_section_attendance_event" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'student_section_attendance_event' is set
        if self.api_client.client_side_validation and ('student_section_attendance_event' not in params or
                                                       params['student_section_attendance_event'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `student_section_attendance_event` when calling `post_student_section_attendance_event`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ed-fi/studentSectionAttendanceEvents', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def put_student_section_attendance_event(self, id, student_section_attendance_event, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_student_section_attendance_event_with_http_info(id, student_section_attendance_event, **kwargs)  # noqa: E501
        else:
            (data) = self.put_student_section_attendance_event_with_http_info(id, student_section_attendance_event, **kwargs)  # noqa: E501
            return data

    def put_student_section_attendance_event_with_http_info(self, id, student_section_attendance_event, **kwargs):  # noqa: E501
        """Updates a resource based on the resource identifier.  # noqa: E501
        ...
        all_params = ['id', 'student_section_attendance_event', 'if_match']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_student_section_attendance_event" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `put_student_section_attendance_event`")  # noqa: E501
        # verify the required parameter 'student_section_attendance_event' is set
        if self.api_client.client_side_validation and ('student_section_attendance_event' not in params or
                                                       params['student_section_attendance_event'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `student_section_attendance_event` when calling `put_student_section_attendance_event`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ed-fi/studentSectionAttendanceEvents/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
