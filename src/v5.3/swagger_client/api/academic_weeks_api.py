...
class AcademicWeeksApi(object):
    ...
    def get_academic_weeks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'week_identifier', 'school_id', 'begin_date', 'end_date', 'id', 'total_instructional_days', 'snapshot_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('week_identifier' in params and
    ...
    def post_academic_week_with_http_info(self, academic_week, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('academic_week' not in params or
                                                       params['academic_week'] is None):  # noqa: E501
