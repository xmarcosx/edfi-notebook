...
class StudentParentAssociationsApi(object):
    ...
    def get_student_parent_associations(self, **kwargs):  # noqa: E501
        ...
        :param str relation_descriptor: The nature of an individual's relationship to a student, primarily used to capture family relationships.
        ...
        :param str id: 
        :param bool legal_guardian: Indicator of whether the person is a legal guardian for the Student.
    ...
    def get_student_parent_associations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'parent_unique_id', 'student_unique_id', 'relation_descriptor', 'contact_priority', 'contact_restrictions', 'emergency_contact_status', 'id', 'legal_guardian', 'lives_with', 'primary_contact_status', 'snapshot_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'legal_guardian' in params:
            query_params.append(('legalGuardian', params['legal_guardian']))  # noqa: E501
