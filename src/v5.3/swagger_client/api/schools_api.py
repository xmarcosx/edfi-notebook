...
class SchoolsApi(object):
    ...
    def delete_school_by_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_school_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_school_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_school_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_school_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes an existing resource using the resource identifier.  # noqa: E501

        The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_school_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_school_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `delete_school_by_id`")  # noqa: E501
    ...
    def deletes_schools(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deletes_schools(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.deletes_schools_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.deletes_schools_with_http_info(**kwargs)  # noqa: E501
            return data

    def deletes_schools_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves deleted resources based on change version.  # noqa: E501

        The DELETES operation is used to retrieve deleted resources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deletes_schools_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deletes_schools" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_schools`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_schools`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_schools(self, **kwargs):  # noqa: E501
        ...
        :param int charter_approval_school_year: The school year in which a charter school was initially approved.
        :param str administrative_funding_control_descriptor: The type of education institution as classified by its funding source, for example public or private.
        :param str charter_approval_agency_type_descriptor: The type of agency that approved the establishment or continuation of a charter school.
        ...
        :param str internet_access_descriptor: The type of Internet access available.
        :param str magnet_special_program_emphasis_school_descriptor: A school that has been designed: 1) to attract students of different racial/ethnic backgrounds for the purpose of reducing, preventing, or eliminating racial isolation; and/or 2) to provide an academic or social focus on a particular theme (e.g., science/math, performing arts, gifted/talented, or foreign language).
        :param str school_type_descriptor: The type of education institution as classified by its primary focus.
        :param str title_i_part_a_school_designation_descriptor: Denotes the Title I Part A designation for the school.
        :param str snapshot_identifier: Indicates the Snapshot-Identifier that should be used.
    ...
    def get_schools_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('administrative_funding_control_descriptor' in params and
            ...
            raise ValueError("Invalid value for parameter `administrative_funding_control_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('charter_approval_agency_type_descriptor' in params and
                                                       len(params['charter_approval_agency_type_descriptor']) > 306):
            raise ValueError("Invalid value for parameter `charter_approval_agency_type_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('charter_status_descriptor' in params and
            ...
            raise ValueError("Invalid value for parameter `charter_status_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('internet_access_descriptor' in params and
                                                       len(params['internet_access_descriptor']) > 306):
            raise ValueError("Invalid value for parameter `internet_access_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('magnet_special_program_emphasis_school_descriptor' in params and
                                                       len(params['magnet_special_program_emphasis_school_descriptor']) > 306):
            raise ValueError("Invalid value for parameter `magnet_special_program_emphasis_school_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('school_type_descriptor' in params and
                                                       len(params['school_type_descriptor']) > 306):
            raise ValueError("Invalid value for parameter `school_type_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        if self.api_client.client_side_validation and ('title_i_part_a_school_designation_descriptor' in params and
                                                       len(params['title_i_part_a_school_designation_descriptor']) > 306):
            raise ValueError("Invalid value for parameter `title_i_part_a_school_designation_descriptor` when calling `get_schools`, length must be less than or equal to `306`")  # noqa: E501
        collection_formats = {}
        ...
        if 'charter_approval_school_year' in params:
            query_params.append(('charterApprovalSchoolYear', params['charter_approval_school_year']))  # noqa: E501
        ...
        if 'charter_approval_agency_type_descriptor' in params:
            query_params.append(('charterApprovalAgencyTypeDescriptor', params['charter_approval_agency_type_descriptor']))  # noqa: E501
        ...
        if 'internet_access_descriptor' in params:
            query_params.append(('internetAccessDescriptor', params['internet_access_descriptor']))  # noqa: E501
        if 'magnet_special_program_emphasis_school_descriptor' in params:
            query_params.append(('magnetSpecialProgramEmphasisSchoolDescriptor', params['magnet_special_program_emphasis_school_descriptor']))  # noqa: E501
        if 'school_type_descriptor' in params:
            query_params.append(('schoolTypeDescriptor', params['school_type_descriptor']))  # noqa: E501
        if 'title_i_part_a_school_designation_descriptor' in params:
            query_params.append(('titleIPartASchoolDesignationDescriptor', params['title_i_part_a_school_designation_descriptor']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[EdFiSchool]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_schools_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EdFiSchool',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_school(self, school, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_school(school, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EdFiSchool school: The JSON representation of the \"school\" resource to be created or updated. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_school_with_http_info(school, **kwargs)  # noqa: E501
        else:
            (data) = self.post_school_with_http_info(school, **kwargs)  # noqa: E501
            return data

    def post_school_with_http_info(self, school, **kwargs):  # noqa: E501
        """Creates or updates resources based on the natural key values of the supplied resource.  # noqa: E501

        The POST operation can be used to create or update resources. In database terms, this is often referred to as an \"upsert\" operation (insert + update). Clients should NOT include the resource \"id\" in the JSON body because it will result in an error. The web service will identify whether the resource already exists based on the natural key values provided, and update or create the resource appropriately. It is recommended to use POST for both create and update except while updating natural key of a resource in which case PUT operation must be used.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_school_with_http_info(school, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_school" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'school' is set
        if self.api_client.client_side_validation and ('school' not in params or
                                                       params['school'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `school` when calling `post_school`")  # noqa: E501
    ...
    def put_school(self, id, school, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_school(id, school, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_school_with_http_info(id, school, **kwargs)  # noqa: E501
        else:
            (data) = self.put_school_with_http_info(id, school, **kwargs)  # noqa: E501
            return data

    def put_school_with_http_info(self, id, school, **kwargs):  # noqa: E501
        """Updates a resource based on the resource identifier.  # noqa: E501

        The PUT operation is used to update a resource by identifier. If the resource identifier (\"id\") is provided in the JSON body, it will be ignored. Additionally, this API resource is not configured for cascading natural key updates. Natural key values for this resource cannot be changed using PUT operation and will not be modified in the database, and so recommendation is to use POST as that supports upsert behavior.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_school_with_http_info(id, school, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'school', 'if_match']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `put_school`")  # noqa: E501
        # verify the required parameter 'school' is set
        if self.api_client.client_side_validation and ('school' not in params or
                                                       params['school'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `school` when calling `put_school`")  # noqa: E501
