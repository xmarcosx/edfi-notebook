...
class BudgetsApi(object):
    ...
    def delete_budget_by_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_budget_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_budget_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_budget_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_budget_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes an existing resource using the resource identifier.  # noqa: E501

        The DELETE operation is used to delete an existing resource by identifier. If the resource doesn't exist, an error will result (the resource will not be found).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_budget_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_budget_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `delete_budget_by_id`")  # noqa: E501
    ...
    def deletes_budgets(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deletes_budgets(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.deletes_budgets_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.deletes_budgets_with_http_info(**kwargs)  # noqa: E501
            return data

    def deletes_budgets_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves deleted resources based on change version.  # noqa: E501

        The DELETES operation is used to retrieve deleted resources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deletes_budgets_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deletes_budgets" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_budgets`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `deletes_budgets`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_budgets(self, **kwargs):  # noqa: E501
        ...
        :param date as_of_date: The date of the reported budget element.
        ...
        :param float amount: Amount budgeted for the account for this fiscal year.
        :param str id: 
        :param str snapshot_identifier: Indicates the Snapshot-Identifier that should be used.
    ...
    def get_budgets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'as_of_date', 'account_identifier', 'education_organization_id', 'fiscal_year', 'amount', 'id', 'snapshot_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 500):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_budgets`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_budgets`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and ('account_identifier' in params and
                                                       len(params['account_identifier']) > 50):
            raise ValueError("Invalid value for parameter `account_identifier` when calling `get_budgets`, length must be less than or equal to `50`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[EdFiBudget]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_budgets_by_id(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_budgets_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_budgets_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_budgets_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_budgets_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).  # noqa: E501

        This GET operation retrieves a resource by the specified resource identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_budgets_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_budgets_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `get_budgets_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EdFiBudget',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_budget(self, budget, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_budget(budget, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EdFiBudget budget: The JSON representation of the \"budget\" resource to be created or updated. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_budget_with_http_info(budget, **kwargs)  # noqa: E501
        else:
            (data) = self.post_budget_with_http_info(budget, **kwargs)  # noqa: E501
            return data

    def post_budget_with_http_info(self, budget, **kwargs):  # noqa: E501
        """Creates or updates resources based on the natural key values of the supplied resource.  # noqa: E501

        The POST operation can be used to create or update resources. In database terms, this is often referred to as an \"upsert\" operation (insert + update). Clients should NOT include the resource \"id\" in the JSON body because it will result in an error. The web service will identify whether the resource already exists based on the natural key values provided, and update or create the resource appropriately. It is recommended to use POST for both create and update except while updating natural key of a resource in which case PUT operation must be used.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_budget_with_http_info(budget, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('budget' not in params or
                                                       params['budget'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `budget` when calling `post_budget`")  # noqa: E501
    ...
    def put_budget(self, id, budget, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_budget(id, budget, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_budget_with_http_info(id, budget, **kwargs)  # noqa: E501
        else:
            (data) = self.put_budget_with_http_info(id, budget, **kwargs)  # noqa: E501
            return data

    def put_budget_with_http_info(self, id, budget, **kwargs):  # noqa: E501
        """Updates a resource based on the resource identifier.  # noqa: E501

        The PUT operation is used to update a resource by identifier. If the resource identifier (\"id\") is provided in the JSON body, it will be ignored. Additionally, this API resource is not configured for cascading natural key updates. Natural key values for this resource cannot be changed using PUT operation and will not be modified in the database, and so recommendation is to use POST as that supports upsert behavior.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_budget_with_http_info(id, budget, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'budget', 'if_match']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `put_budget`")  # noqa: E501
        # verify the required parameter 'budget' is set
        if self.api_client.client_side_validation and ('budget' not in params or
                                                       params['budget'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `budget` when calling `put_budget`")  # noqa: E501
