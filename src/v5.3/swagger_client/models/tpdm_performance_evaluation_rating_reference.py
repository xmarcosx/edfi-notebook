...
class TpdmPerformanceEvaluationRatingReference(object):
    ...
    def __init__(self, education_organization_id=None, evaluation_period_descriptor=None, performance_evaluation_title=None, performance_evaluation_type_descriptor=None, person_id=None, school_year=None, source_system_descriptor=None, term_descriptor=None, link=None, _configuration=None):  # noqa: E501
