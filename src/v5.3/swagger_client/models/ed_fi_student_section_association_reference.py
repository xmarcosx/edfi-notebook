...
class EdFiStudentSectionAssociationReference(object):
    ...
    def __init__(self, begin_date=None, local_course_code=None, school_id=None, school_year=None, section_identifier=None, session_name=None, student_unique_id=None, link=None, _configuration=None):  # noqa: E501
