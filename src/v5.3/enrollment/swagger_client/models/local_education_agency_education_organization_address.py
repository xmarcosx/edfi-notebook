...
class LocalEducationAgencyEducationOrganizationAddress(object):
    ...
    def __init__(self, address_type_descriptor=None, street_number_name=None, city=None, state_abbreviation_descriptor=None, postal_code=None, name_of_county=None, _configuration=None):  # noqa: E501
        """LocalEducationAgencyEducationOrganizationAddress - a model defined in Swagger"""  # noqa: E501
    ...
    def address_type_descriptor(self):
        """Gets the address_type_descriptor of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        ...
        :return: The address_type_descriptor of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def address_type_descriptor(self, address_type_descriptor):
        """Sets the address_type_descriptor of this LocalEducationAgencyEducationOrganizationAddress.

        The type of address listed for an individual or organization.    For example:  Physical Address, Mailing Address, Home Address, etc.)  # noqa: E501

        :param address_type_descriptor: The address_type_descriptor of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :type: str
        """
    ...
    def street_number_name(self):
        """Gets the street_number_name of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501

        The street number and street name or post office box number of an address.  # noqa: E501

        :return: The street_number_name of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def street_number_name(self, street_number_name):
        """Sets the street_number_name of this LocalEducationAgencyEducationOrganizationAddress.

        The street number and street name or post office box number of an address.  # noqa: E501

        :param street_number_name: The street_number_name of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def city(self):
        """Gets the city of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501

        The name of the city in which an address is located.  # noqa: E501

        :return: The city of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :rtype: str
        """
        return self._city
    ...
    @city.setter
    def city(self, city):
        """Sets the city of this LocalEducationAgencyEducationOrganizationAddress.

        The name of the city in which an address is located.  # noqa: E501

        :param city: The city of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :type: str
        """
    ...
    def state_abbreviation_descriptor(self):
        """Gets the state_abbreviation_descriptor of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501

        The abbreviation for the state (within the United States) or outlying area in which an address is located.  # noqa: E501

        :return: The state_abbreviation_descriptor of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def state_abbreviation_descriptor(self, state_abbreviation_descriptor):
        """Sets the state_abbreviation_descriptor of this LocalEducationAgencyEducationOrganizationAddress.

        The abbreviation for the state (within the United States) or outlying area in which an address is located.  # noqa: E501

        :param state_abbreviation_descriptor: The state_abbreviation_descriptor of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :type: str
        """
    ...
    def postal_code(self):
        """Gets the postal_code of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501

        The five or nine digit zip code or overseas postal code portion of an address.  # noqa: E501

        :return: The postal_code of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def postal_code(self, postal_code):
        """Sets the postal_code of this LocalEducationAgencyEducationOrganizationAddress.

        The five or nine digit zip code or overseas postal code portion of an address.  # noqa: E501

        :param postal_code: The postal_code of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :type: str
        """
    ...
    def name_of_county(self):
        """Gets the name_of_county of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501

        The name of the county, parish, borough, or comparable unit (within a state) in                      'which an address is located.  # noqa: E501

        :return: The name_of_county of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :rtype: str
        """
    ...
    def name_of_county(self, name_of_county):
        """Sets the name_of_county of this LocalEducationAgencyEducationOrganizationAddress.

        The name of the county, parish, borough, or comparable unit (within a state) in                      'which an address is located.  # noqa: E501

        :param name_of_county: The name_of_county of this LocalEducationAgencyEducationOrganizationAddress.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocalEducationAgencyEducationOrganizationAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocalEducationAgencyEducationOrganizationAddress):
            return False
