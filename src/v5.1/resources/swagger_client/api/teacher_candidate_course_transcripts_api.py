...
class TeacherCandidateCourseTranscriptsApi(object):
    ...
    def post_teacher_candidate_course_transcript_with_http_info(self, teacher_candidate_course_transcript, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('teacher_candidate_course_transcript' not in params or
                                                       params['teacher_candidate_course_transcript'] is None):  # noqa: E501
