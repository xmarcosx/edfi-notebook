...
class CertificationExamResultsApi(object):
    ...
    def get_certification_exam_results_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('certification_exam_status_descriptor' in params and
    ...
    def post_certification_exam_result_with_http_info(self, certification_exam_result, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('certification_exam_result' not in params or
                                                       params['certification_exam_result'] is None):  # noqa: E501
