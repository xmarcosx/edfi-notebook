...
class BudgetsApi(object):
    ...
    def get_budgets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['offset', 'limit', 'min_change_version', 'max_change_version', 'total_count', 'as_of_date', 'account_identifier', 'education_organization_id', 'fiscal_year', 'amount', 'id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
