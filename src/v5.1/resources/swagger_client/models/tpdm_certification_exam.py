...
class TpdmCertificationExam(object):
    ...
    def __init__(self, id=None, certification_exam_identifier=None, namespace=None, education_organization_reference=None, certification_exam_title=None, certification_exam_type_descriptor=None, effective_date=None, end_date=None, etag=None, _configuration=None):  # noqa: E501
    ...
    def certification_exam_title(self, certification_exam_title):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and certification_exam_title is None:
            raise ValueError("Invalid value for `certification_exam_title`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                certification_exam_title is not None and len(certification_exam_title) > 60):
    ...
    def certification_exam_type_descriptor(self, certification_exam_type_descriptor):
        ...
        """
        if (self._configuration.client_side_validation and
                certification_exam_type_descriptor is not None and len(certification_exam_type_descriptor) > 306):
