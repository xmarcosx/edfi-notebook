...
class TpdmTeacherCandidateDisability(object):
    ...
    swagger_types = {
        ...
        'designations': 'list[TpdmTeacherCandidateDisabilityDesignation]'
    }
    ...
    def __init__(self, disability_descriptor=None, disability_determination_source_type_descriptor=None, disability_diagnosis=None, order_of_disability=None, designations=None, _configuration=None):  # noqa: E501
        """TpdmTeacherCandidateDisability - a model defined in Swagger"""  # noqa: E501
    ...
    def disability_descriptor(self):
        """Gets the disability_descriptor of this TpdmTeacherCandidateDisability.  # noqa: E501

        A disability category that describes a child's impairment.  # noqa: E501

        :return: The disability_descriptor of this TpdmTeacherCandidateDisability.  # noqa: E501
        :rtype: str
        """
    ...
    def disability_descriptor(self, disability_descriptor):
        """Sets the disability_descriptor of this TpdmTeacherCandidateDisability.

        A disability category that describes a child's impairment.  # noqa: E501

        :param disability_descriptor: The disability_descriptor of this TpdmTeacherCandidateDisability.  # noqa: E501
        :type: str
        """
    ...
    def disability_determination_source_type_descriptor(self):
        """Gets the disability_determination_source_type_descriptor of this TpdmTeacherCandidateDisability.  # noqa: E501

        The source that provided the disability determination.  # noqa: E501

        :return: The disability_determination_source_type_descriptor of this TpdmTeacherCandidateDisability.  # noqa: E501
        :rtype: str
        """
    ...
    def disability_determination_source_type_descriptor(self, disability_determination_source_type_descriptor):
        """Sets the disability_determination_source_type_descriptor of this TpdmTeacherCandidateDisability.

        The source that provided the disability determination.  # noqa: E501

        :param disability_determination_source_type_descriptor: The disability_determination_source_type_descriptor of this TpdmTeacherCandidateDisability.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def disability_diagnosis(self):
        """Gets the disability_diagnosis of this TpdmTeacherCandidateDisability.  # noqa: E501

        A description of the disability diagnosis.  # noqa: E501

        :return: The disability_diagnosis of this TpdmTeacherCandidateDisability.  # noqa: E501
        :rtype: str
        """
    ...
    def disability_diagnosis(self, disability_diagnosis):
        """Sets the disability_diagnosis of this TpdmTeacherCandidateDisability.

        A description of the disability diagnosis.  # noqa: E501

        :param disability_diagnosis: The disability_diagnosis of this TpdmTeacherCandidateDisability.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def order_of_disability(self):
        """Gets the order_of_disability of this TpdmTeacherCandidateDisability.  # noqa: E501

        The order by severity of student's disabilities: 1- Primary, 2 -  Secondary, 3 - Tertiary, etc.  # noqa: E501

        :return: The order_of_disability of this TpdmTeacherCandidateDisability.  # noqa: E501
        :rtype: int
        """
    ...
    def order_of_disability(self, order_of_disability):
        """Sets the order_of_disability of this TpdmTeacherCandidateDisability.

        The order by severity of student's disabilities: 1- Primary, 2 -  Secondary, 3 - Tertiary, etc.  # noqa: E501

        :param order_of_disability: The order_of_disability of this TpdmTeacherCandidateDisability.  # noqa: E501
        :type: int
        """
    ...
    def designations(self):
        """Gets the designations of this TpdmTeacherCandidateDisability.  # noqa: E501

        An unordered collection of teacherCandidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.  # noqa: E501

        :return: The designations of this TpdmTeacherCandidateDisability.  # noqa: E501
        :rtype: list[TpdmTeacherCandidateDisabilityDesignation]
        """
        return self._designations

    @designations.setter
    def designations(self, designations):
        """Sets the designations of this TpdmTeacherCandidateDisability.

        An unordered collection of teacherCandidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.  # noqa: E501

        :param designations: The designations of this TpdmTeacherCandidateDisability.  # noqa: E501
        :type: list[TpdmTeacherCandidateDisabilityDesignation]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmTeacherCandidateDisability, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmTeacherCandidateDisability):
            return False
