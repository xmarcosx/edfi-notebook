...
class TpdmQuantitativeMeasureScore(object):
    ...
    def __init__(self, id=None, evaluation_element_rating_reference=None, quantitative_measure_reference=None, score_value=None, standard_error=None, etag=None, _configuration=None):  # noqa: E501
    ...
    def quantitative_measure_reference(self, quantitative_measure_reference):
        ...
        """
        if self._configuration.client_side_validation and quantitative_measure_reference is None:
