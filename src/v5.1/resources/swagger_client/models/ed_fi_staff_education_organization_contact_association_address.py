...
class EdFiStaffEducationOrganizationContactAssociationAddress(object):
    ...
    def __init__(self, address_type_descriptor=None, locale_descriptor=None, state_abbreviation_descriptor=None, apartment_room_suite_number=None, building_site_number=None, city=None, congressional_district=None, county_fips_code=None, do_not_publish_indicator=None, latitude=None, longitude=None, name_of_county=None, postal_code=None, street_number_name=None, periods=None, _configuration=None):  # noqa: E501
