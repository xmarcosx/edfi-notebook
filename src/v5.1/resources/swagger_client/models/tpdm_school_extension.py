...
class TpdmSchoolExtension(object):
    ...
    def __init__(self, federal_locale_code_descriptor=None, school_status_descriptor=None, improving_school=None, _configuration=None):  # noqa: E501
    ...
    def school_status_descriptor(self, school_status_descriptor):
        ...
        """
        if (self._configuration.client_side_validation and
                school_status_descriptor is not None and len(school_status_descriptor) > 306):
