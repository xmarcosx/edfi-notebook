...
class TpdmStaffSeniority(object):
    ...
    def __init__(self, credential_field_descriptor=None, name_of_institution=None, years_experience=None, _configuration=None):  # noqa: E501
    ...
    def years_experience(self, years_experience):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and years_experience is None:
