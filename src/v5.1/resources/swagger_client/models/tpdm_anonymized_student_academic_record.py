...
class TpdmAnonymizedStudentAcademicRecord(object):
    ...
    def __init__(self, id=None, fact_as_of_date=None, term_descriptor=None, anonymized_student_reference=None, education_organization_reference=None, school_year_type_reference=None, cumulative_grade_point_average=None, gpa_max=None, session_grade_point_average=None, etag=None, _configuration=None):  # noqa: E501
