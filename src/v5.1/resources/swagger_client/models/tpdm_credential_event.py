...
class TpdmCredentialEvent(object):
    ...
    def __init__(self, id=None, credential_event_date=None, credential_event_type_descriptor=None, credential_reference=None, credential_event_reason=None, etag=None, _configuration=None):  # noqa: E501
    ...
    def credential_event_date(self, credential_event_date):
        ...
        :type: date
        """
        if self._configuration.client_side_validation and credential_event_date is None:
    ...
    def credential_event_type_descriptor(self, credential_event_type_descriptor):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and credential_event_type_descriptor is None:
            raise ValueError("Invalid value for `credential_event_type_descriptor`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                credential_event_type_descriptor is not None and len(credential_event_type_descriptor) > 306):
    ...
    def credential_event_reason(self, credential_event_reason):
        ...
        """
        if (self._configuration.client_side_validation and
                credential_event_reason is not None and len(credential_event_reason) > 1024):
