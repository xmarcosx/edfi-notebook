...
class TpdmPerformanceEvaluation(object):
    ...
    def __init__(self, id=None, evaluation_period_descriptor=None, performance_evaluation_title=None, performance_evaluation_type_descriptor=None, term_descriptor=None, education_organization_reference=None, school_year_type_reference=None, academic_subject_descriptor=None, grade_levels=None, program_gateways=None, rating_levels=None, etag=None, _configuration=None):  # noqa: E501
