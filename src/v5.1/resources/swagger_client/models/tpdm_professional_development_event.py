...
class TpdmProfessionalDevelopmentEvent(object):
    ...
    def __init__(self, id=None, namespace=None, professional_development_title=None, multiple_session=None, professional_development_offered_by_descriptor=None, professional_development_reason=None, required=None, total_hours=None, etag=None, _configuration=None):  # noqa: E501
    ...
    def professional_development_offered_by_descriptor(self, professional_development_offered_by_descriptor):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and professional_development_offered_by_descriptor is None:
            raise ValueError("Invalid value for `professional_development_offered_by_descriptor`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                professional_development_offered_by_descriptor is not None and len(professional_development_offered_by_descriptor) > 306):
    ...
    def professional_development_reason(self, professional_development_reason):
        ...
        """
        if (self._configuration.client_side_validation and
                professional_development_reason is not None and len(professional_development_reason) > 60):
