...
class EdFiCredentialAcademicSubject(object):
    ...
    def __init__(self, academic_subject_descriptor=None, _configuration=None):  # noqa: E501
        """EdFiCredentialAcademicSubject - a model defined in Swagger"""  # noqa: E501
    ...
    def academic_subject_descriptor(self):
        """Gets the academic_subject_descriptor of this EdFiCredentialAcademicSubject.  # noqa: E501

        The academic subjects to which the credential pertains.  # noqa: E501

        :return: The academic_subject_descriptor of this EdFiCredentialAcademicSubject.  # noqa: E501
        :rtype: str
        """
    ...
    def academic_subject_descriptor(self, academic_subject_descriptor):
        """Sets the academic_subject_descriptor of this EdFiCredentialAcademicSubject.

        The academic subjects to which the credential pertains.  # noqa: E501

        :param academic_subject_descriptor: The academic_subject_descriptor of this EdFiCredentialAcademicSubject.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EdFiCredentialAcademicSubject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdFiCredentialAcademicSubject):
            return False
