...
class TpdmEmploymentEvent(object):
    ...
    def __init__(self, id=None, employment_event_type_descriptor=None, open_staff_position_reference=None, early_hire=None, hire_date=None, internal_external_hire_descriptor=None, mutual_consent=None, restricted_choice=None, etag=None, _configuration=None):  # noqa: E501
    ...
    def employment_event_type_descriptor(self, employment_event_type_descriptor):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and employment_event_type_descriptor is None:
            raise ValueError("Invalid value for `employment_event_type_descriptor`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                employment_event_type_descriptor is not None and len(employment_event_type_descriptor) > 306):
    ...
    def internal_external_hire_descriptor(self, internal_external_hire_descriptor):
        ...
        """
        if (self._configuration.client_side_validation and
                internal_external_hire_descriptor is not None and len(internal_external_hire_descriptor) > 306):
