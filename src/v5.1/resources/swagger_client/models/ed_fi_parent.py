...
class EdFiParent(object):
    ...
    def __init__(self, id=None, parent_unique_id=None, person_reference=None, addresses=None, electronic_mails=None, first_name=None, generation_code_suffix=None, international_addresses=None, languages=None, last_surname=None, login_id=None, maiden_name=None, middle_name=None, other_names=None, personal_identification_documents=None, personal_title_prefix=None, sex_descriptor=None, telephones=None, etag=None, _configuration=None):  # noqa: E501
