...
class TpdmEvaluationRating(object):
    ...
    def __init__(self, id=None, evaluation_date=None, evaluation_reference=None, performance_evaluation_rating_reference=None, section_reference=None, evaluation_rating_level_descriptor=None, results=None, reviewers=None, etag=None, _configuration=None):  # noqa: E501
