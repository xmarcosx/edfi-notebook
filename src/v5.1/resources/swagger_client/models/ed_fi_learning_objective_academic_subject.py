...
class EdFiLearningObjectiveAcademicSubject(object):
    ...
    def __init__(self, academic_subject_descriptor=None, _configuration=None):  # noqa: E501
        """EdFiLearningObjectiveAcademicSubject - a model defined in Swagger"""  # noqa: E501
    ...
    def academic_subject_descriptor(self):
        """Gets the academic_subject_descriptor of this EdFiLearningObjectiveAcademicSubject.  # noqa: E501

        The description of the content or subject area (e.g., arts, mathematics, reading, stenography, or a foreign language) of an assessment.  # noqa: E501

        :return: The academic_subject_descriptor of this EdFiLearningObjectiveAcademicSubject.  # noqa: E501
        :rtype: str
        """
    ...
    def academic_subject_descriptor(self, academic_subject_descriptor):
        """Sets the academic_subject_descriptor of this EdFiLearningObjectiveAcademicSubject.

        The description of the content or subject area (e.g., arts, mathematics, reading, stenography, or a foreign language) of an assessment.  # noqa: E501

        :param academic_subject_descriptor: The academic_subject_descriptor of this EdFiLearningObjectiveAcademicSubject.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EdFiLearningObjectiveAcademicSubject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdFiLearningObjectiveAcademicSubject):
            return False
