...
class TpdmProspectCurrentPosition(object):
    ...
    def __init__(self, academic_subject_descriptor=None, location=None, name_of_institution=None, position_title=None, grade_levels=None, _configuration=None):  # noqa: E501
    ...
    def position_title(self, position_title):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and position_title is None:
