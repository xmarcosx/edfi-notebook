...
class TpdmEvaluationRatingLevel(object):
    ...
    def __init__(self, evaluation_rating_level_descriptor=None, max_rating=None, min_rating=None, _configuration=None):  # noqa: E501
        """TpdmEvaluationRatingLevel - a model defined in Swagger"""  # noqa: E501
    ...
    def evaluation_rating_level_descriptor(self):
        """Gets the evaluation_rating_level_descriptor of this TpdmEvaluationRatingLevel.  # noqa: E501

        The title for a level of rating or evaluation band (e.g., Excellent, Acceptable, Needs Improvement, Unacceptable).  # noqa: E501

        :return: The evaluation_rating_level_descriptor of this TpdmEvaluationRatingLevel.  # noqa: E501
        :rtype: str
        """
    ...
    def evaluation_rating_level_descriptor(self, evaluation_rating_level_descriptor):
        """Sets the evaluation_rating_level_descriptor of this TpdmEvaluationRatingLevel.

        The title for a level of rating or evaluation band (e.g., Excellent, Acceptable, Needs Improvement, Unacceptable).  # noqa: E501

        :param evaluation_rating_level_descriptor: The evaluation_rating_level_descriptor of this TpdmEvaluationRatingLevel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def max_rating(self):
        """Gets the max_rating of this TpdmEvaluationRatingLevel.  # noqa: E501

        The maximum numerical rating or score to achieve the evaluation rating level.  # noqa: E501

        :return: The max_rating of this TpdmEvaluationRatingLevel.  # noqa: E501
        :rtype: float
        """
    ...
    def max_rating(self, max_rating):
        """Sets the max_rating of this TpdmEvaluationRatingLevel.

        The maximum numerical rating or score to achieve the evaluation rating level.  # noqa: E501

        :param max_rating: The max_rating of this TpdmEvaluationRatingLevel.  # noqa: E501
        :type: float
        """
    ...
    @property
    def min_rating(self):
        """Gets the min_rating of this TpdmEvaluationRatingLevel.  # noqa: E501

        The minimum numerical rating or score to achieve the evaluation rating level.  # noqa: E501

        :return: The min_rating of this TpdmEvaluationRatingLevel.  # noqa: E501
        :rtype: float
        """
    ...
    def min_rating(self, min_rating):
        """Sets the min_rating of this TpdmEvaluationRatingLevel.

        The minimum numerical rating or score to achieve the evaluation rating level.  # noqa: E501

        :param min_rating: The min_rating of this TpdmEvaluationRatingLevel.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TpdmEvaluationRatingLevel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TpdmEvaluationRatingLevel):
            return False
