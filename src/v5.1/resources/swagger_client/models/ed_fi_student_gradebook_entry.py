...
class EdFiStudentGradebookEntry(object):
    ...
    def __init__(self, id=None, gradebook_entry_reference=None, student_section_association_reference=None, competency_level_descriptor=None, date_fulfilled=None, diagnostic_statement=None, letter_grade_earned=None, numeric_grade_earned=None, etag=None, ext=None, _configuration=None):  # noqa: E501
