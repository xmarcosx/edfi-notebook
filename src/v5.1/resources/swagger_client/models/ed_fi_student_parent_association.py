...
class EdFiStudentParentAssociation(object):
    ...
    def __init__(self, id=None, parent_reference=None, student_reference=None, contact_priority=None, contact_restrictions=None, emergency_contact_status=None, lives_with=None, primary_contact_status=None, relation_descriptor=None, etag=None, _configuration=None):  # noqa: E501
