...
class EdFiCredential(object):
    ...
    def credential_field_descriptor(self, credential_field_descriptor):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and credential_field_descriptor is None:
    ...
    def teaching_credential_descriptor(self, teaching_credential_descriptor):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and teaching_credential_descriptor is None:
