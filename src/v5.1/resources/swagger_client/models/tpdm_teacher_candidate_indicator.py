...
class TpdmTeacherCandidateIndicator(object):
    ...
    def __init__(self, indicator_name=None, begin_date=None, designated_by=None, end_date=None, indicator=None, indicator_group=None, _configuration=None):  # noqa: E501
