...
class TpdmProspectAid(object):
    ...
    def __init__(self, aid_type_descriptor=None, aid_amount=None, aid_condition_description=None, begin_date=None, end_date=None, pell_grant_recipient=None, _configuration=None):  # noqa: E501
